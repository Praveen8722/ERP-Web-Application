...
var Emitter = (function () {
  ...
  Dropzone = (function () {
    ...
    function t(n, i) {
      ...
      t.instances.push(_assertThisInitialized(r)),
        (r.element.dropzone = _assertThisInitialized(r));
      var l = null != (a = t.optionsForElement(r.element)) ? a : {};
      if (
        ((r.options = t.extend({}, r.defaultOptions, l, null != i ? i : {})),
        r.options.forceFallback || !t.isBrowserSupported())
      )
        return _possibleConstructorReturn(
          r,
          r.options.fallback.call(_assertThisInitialized(r))
        );
      if (
        (null == r.options.url &&
      ...
      return (
        ...
        null != r.options.renameFilename &&
          (r.options.renameFile = function (e) {
            return r.options.renameFilename.call(
              ...
              (this.prototype.defaultOptions = {
                ...
                addedfile: function (e) {
                  ...
                  if (
                    ...
                    try {
                      for (l.s(); !(a = l.n()).done; )
                        (o = a.value).innerHTML = this.filesize(e.size);
                    } catch (i) {
                      l.e(i);
                    } finally {
                      l.f();
        ...
        [
          ...
          },
          {
            ...
            value: function () {
                ...
                this.clickableElements.length &&
                  (function n() {
                    return (
                      ...
                      (null === e.options.maxFiles || 1 < e.options.maxFiles) &&
              ...
              var n,
                i = _createForOfIteratorHelper(this.events);
              try {
                for (i.s(); !(n = i.n()).done; ) {
                  var r = n.value;
          ...
          },
          {
            ...
            value: function (e) {
              null == e && (e = !1);
              var n,
                i = _createForOfIteratorHelper(this.files.slice());
              try {
                for (i.s(); !(n = i.n()).done; ) {
                  var r = n.value;
            ...
            value: function (e, n) {
              ...
              if (this.options.params) {
                ...
                h)) {
                  var m = h[f];
                  if (Array.isArray(m))
                    for (var v = 0; v < m.length; v++) p.append(f, m[v]);
                  else p.append(f, m);
                }
              }
              var y,
