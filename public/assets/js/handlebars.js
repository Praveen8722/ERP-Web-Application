  ...
  return (function (t) {
    ...
    function (t, e) {
      ...
      var l =
        ...
        function (t) {
          return (
            !(!t || "object" !== _typeof(t)) && "[object Array]" === a.call(t)
          );
        };
      e.isArray = l;
    },
      ...
      (e.default = function (t) {
        t.registerHelper("with", function (t, e) {
          ...
          return (
            e.data &&
              e.ids &&
              ((n = s.createFrame(e.data)).contextPath = s.appendContextPath(
                e.data.contextPath,
                e.ids[0]
              )),
            r(t, {
    ...
    function (t, e, r) {
      ...
      (e.__esModule = !0),
        ...
        (e.template = function (t, e) {
          ...
          if (!t || !t.main)
            throw new c.default("Unknown template object: " + _typeof(t));
          ...
          var i = {
            ...
            lookup: function (t, e) {
              for (var r = t.length, n = 0; n < r; n++) {
                if (null != (t[n] && i.lookupProperty(t[n], e))) return t[n][e];
              }
            },
            lambda: function (t, e) {
            ...
            invokePartial: function (r, n, s) {
              s.hash &&
                ((n = a.extend({}, n, s.hash)), s.ids && (s.ids[0] = !0)),
              ...
              if (
                (null == o &&
                  e.compile &&
                  ((s.partials[s.name] = e.compile(r, t.compilerOptions, e)),
            ...
            (o._setup = function (n) {
              if (n.partial)
                ...
                !(function (t, e) {
                  ...
                  (i.helpers = o),
                  t.usePartial &&
                    (i.partials = i.mergeIfNeeded(n.partials, e.partials)),
                  (t.usePartial || t.useDecorators) &&
                    (i.decorators = a.extend({}, e.decorators, n.decorators)),
                  (i.hooks = {}),
      ...
      function m(t, e) {
        return (
          (e && "root" in e) || ((e = e ? l.createFrame(e) : {}).root = t), e
        );
      }
              ...
              p.close && c(n, s, !0),
                ...
                e &&
                  ...
                  l(n, s) &&
                    ...
                    (u.indent = /([ \t]+$)/.exec(n[s - 1].original)[1])),
                e && d && (c((u.program || u.inverse).body), l(n, s)),
                e && m && (c(n, s), l((u.inverse || u.program).body));
            }
          }
          return t;
        }),
    ...
    function (t, e, r) {
      ...
      (e.__esModule = !0),
        ...
        (e.prepareBlock = function (t, e, r, n, o, a) {
          ...
          if (r) {
            if (c)
              throw new s.default("Unexpected inverse block on decorator", r);
        ...
        equals: function (t) {
          ...
          for (var r = 0; r < e; r++) {
            var n = this.opcodes[r],
              s = t.opcodes[r];
            if (n.opcode !== s.opcode || !u(n.args, s.args)) return !1;
          }
    ...
    function (t, e, r) {
      ...
      (u.prototype = {
            ...
            this.push(
              (function (t, e, r, n) {
                var s = e.popStack(),
                  ...
                  o = r.length;
                t && o--;
                for (; i < o; i++) s = e.nameLookup(s, r[i], n);
                return t
                  ? [
        ...
        compileChildren: function (t, e) {
          for (
            var r = t.children, n = void 0, s = void 0, i = 0, o = r.length;
            i < o;
            i++
          ) {
        ...
        setupParams: function (t, e, r) {
          ...
          for (var p = e; p--; )
            (c = this.popStack()),
              ...
              this.stringParams &&
                ((i[p] = this.popStack()), (s[p] = this.popStack()));
          return (
