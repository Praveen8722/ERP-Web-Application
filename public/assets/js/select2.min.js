              ...
              this.data.current(function (r) {
                ...
                n.$results
                  ...
                  .each(function () {
                    ...
                    (null == r.element && -1 < e.inArray(o, i))
          ...
          return (
            ...
            (e.prototype._checkIfMaximumSelected = function (e, t) {
              ...
              this.current(function (e) {
                ...
                0 < n.maximumSelectionLength && r >= n.maximumSelectionLength
            ...
            return (
              ...
              (O.prototype._resolveLanguage = function (t) {
                ...
                for (var r = [], i = 0; i < n.length; i++)
                  if (
                    (r.push(n[i]),
                    "string" == typeof n[i] && 0 < n[i].indexOf("-"))
                  ) {
                    var o = n[i].split("-")[0];
                    r.push(o);
                  }
        ...
        t.define(
          ...
          function (e, t, n, r) {
            var i = function e(r, i) {
              null != n.GetData(r[0], "select2") &&
                n.GetData(r[0], "select2").destroy(),
                (this.$element = r),
                (this.id = this._generateId(r)),
                (i = i || {}),
                (this.options = new t(i, r)),
              ...
              (this.selection = new l(r, this.options)),
                (this.$selection = this.selection.render()),
                this.selection.position(this.$selection, a);
              var c = this.options.get("dropdownAdapter");
              (this.dropdown = new c(r, this.options)),
                (this.$dropdown = this.dropdown.render()),
                this.dropdown.position(this.$dropdown, a);
              var u = this.options.get("resultsAdapter");
              (this.results = new u(r, this.options, this.dataAdapter)),
              ...
              this._bindAdapters(),
                ...
                r.addClass("select2-hidden-accessible"),
                r.attr("aria-hidden", "true"),
                this._syncAttributes(),
                n.StoreData(r[0], "select2", this),
                r.data("select2", this);
            };
            return (
