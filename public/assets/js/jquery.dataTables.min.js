...
!(function (t) {
  ...
  function D(e, n) {
    ...
    return (
      ...
      n.map(function (t, n) {
        return (a = R(e, n)), y(e, a.data, n, a.cells);
      })
    );
  }
  function _(t, e, n, r) {
  ...
  function w(e) {
    ...
    if (
      ...
      var r = function t(e, n, r) {
        var o, i;
        if ("" !== r)
          for (var l = 0, s = (i = C(r)).length; l < s; l++) {
            if (((r = i[l].match(fe)), (o = i[l].match(de)), r)) {
              if (
                ((i[l] = i[l].replace(fe, "")),
                "" !== i[l] && (e = e[i[l]]),
                (o = []),
                ...
                for (l = 0, s = e.length; l < s; l++) o.push(t(e[l], n, i));
              e =
                "" === (e = r[0].substring(1, r[0].length - 1)) ? o : o.join(e);
              break;
            }
            if (o) (i[l] = i[l].replace(de, "")), (e = e[i[l]]());
            else {
              if (null === e || e[i[l]] === a) return a;
              e = e[i[l]];
            }
          }
        return e;
          ...
          if (((i = r[s].match(fe)), (l = r[s].match(de)), i)) {
            if (
              ...
              for (l = 0, u = n.length; l < u; l++)
                t((o = {}), n[l], i), e[r[s]].push(o);
            else e[r[s]] = n;
            return;
          }
          l && ((r[s] = r[s].replace(de, "")), (e = e[r[s]](n))),
            (null !== e[r[s]] && e[r[s]] !== a) || (e[r[s]] = {}),
            (e = e[r[s]]);
        }
        o.match(de) ? e[o.replace(de, "")](n) : (e[o.replace(fe, "")] = n);
      };
      return function (t, a) {
        return n(t, a, e);
      };
    ...
    if (null === d.nTr) {
      for (
        ...
        (s = e.aoColumns[u]),
          ...
          s.fnCreatedCell &&
            s.fnCreatedCell.call(e.oInstance, l, _(e, a, u), h, a, u);
      Ht(e, "aoRowCreatedCallback", null, [i, h, a, p]);
    }
  ...
  function B(e, n, a) {
    if ((Ht(e, "aoServerParams", "serverParams", [n]), n && Array.isArray(n))) {
      var r = {},
        o = /(.*?)\[\]$/;
    ...
    (r = S.scrollHeight > S.clientHeight),
      e.scrollBarVis !== r && e.scrollBarVis !== a
        ...
        : ((e.scrollBarVis = r),
          ...
          s || ((y.width = "100%"), (d[0].style.width = "100%")),
          ...
          !c && F && (y.height = vt(w.offsetHeight + f)),
          (s = C.outerWidth()),
          ...
          A &&
            ...
            (D[0].style.width = vt(s)),
            (D[0].style[c] = u ? f + "px" : "0px")),
  ...
  function Dt(t) {
    var e,
      ...
      s = 0,
      u = t.aiDisplayMaster;
    for (S(t), e = 0, n = (r = yt(t)).length; e < n; e++)
  ...
  var Ut,
        ...
        this.each(function () {
          ...
          if ("table" != this.nodeName.toLowerCase())
            ...
            l(_),
              s(_.column),
              o(_, _, !0),
              o(_.column, _.column, !0),
              o(_, t.extend(b, T.data()), !0);
            var C = e.settings;
            m = 0;
            for (p = C.length; m < p; m++) {
              ...
              if (
                ...
                var A = b.bRetrieve !== a ? b.bRetrieve : _.bRetrieve;
                if (c || A) return x.oInstance;
                if (b.bDestroy !== a ? b.bDestroy : _.bDestroy) {
            ...
            (null !== g && "" !== g) ||
              (this.id = g = "DataTables_Table_" + e.ext._unique++);
            var I = t.extend(!0, {}, e.models.oSettings, {
            ...
            (I.nTable = this),
              ...
              (I.oInit = b),
              C.push(I),
              (I.oInstance = 1 === r.length ? r : T.dataTable()),
              l(b),
              i(b.oLanguage),
              b.aLengthMenu &&
                !b.iDisplayLength &&
                (b.iDisplayLength = Array.isArray(b.aLengthMenu[0])
                  ? b.aLengthMenu[0][0]
                  : b.aLengthMenu[0]),
              (b = Pt(t.extend(!0, {}, _), b)),
              Rt(
              ...
              Rt(I.oLanguage, b, "fnInfoCallback"),
              Nt(I, "aoDrawCallback", b.fnDrawCallback, "user"),
              Nt(I, "aoServerParams", b.fnServerParams, "user"),
              Nt(I, "aoStateSaveParams", b.fnStateSaveParams, "user"),
              Nt(I, "aoStateLoadParams", b.fnStateLoadParams, "user"),
              Nt(I, "aoStateLoaded", b.fnStateLoaded, "user"),
              Nt(I, "aoRowCallback", b.fnRowCallback, "user"),
              Nt(I, "aoRowCreatedCallback", b.fnCreatedRow, "user"),
              Nt(I, "aoHeaderCallback", b.fnHeaderCallback, "user"),
              Nt(I, "aoFooterCallback", b.fnFooterCallback, "user"),
              Nt(I, "aoInitComplete", b.fnInitComplete, "user"),
              Nt(I, "aoPreDrawCallback", b.fnPreDrawCallback, "user"),
              (I.rowIdFn = w(b.rowId)),
              u(I);
            var F = I.oClasses;
            t.extend(F, e.ext.classes, b.oClasses),
              T.addClass(F.sTable),
              I.iInitDisplayStart === a &&
                ((I.iInitDisplayStart = b.iDisplayStart),
                (I._iDisplayStart = b.iDisplayStart)),
              null !== b.iDeferLoading &&
                ((I.bDeferLoading = !0),
                (g = Array.isArray(b.iDeferLoading)),
                (I._iRecordsDisplay = g ? b.iDeferLoading[0] : b.iDeferLoading),
                (I._iRecordsTotal = g ? b.iDeferLoading[1] : b.iDeferLoading));
            var L = I.oLanguage;
            t.extend(!0, L, b.oLanguage),
              L.sUrl &&
                (t.ajax({
                  dataType: "json",
                  url: L.sUrl,
                  success: function (e) {
                    i(e), o(_.oLanguage, e), t.extend(!0, L, e), rt(I);
                  },
                  error: function () {
                    rt(I);
                  },
              ...
              null === b.asStripeClasses &&
                (I.asStripeClasses = [F.sStripeOdd, F.sStripeEven]);
            g = I.asStripeClasses;
            ...
            if (
              (-1 !==
                ...
                (t("tbody tr", this).removeClass(g.join(" ")),
                (I.asDestroyStripes = g.slice())),
              (g = []),
              0 !== (C = this.getElementsByTagName("thead")).length &&
                (W(I.aoHeader, C[0]), (g = E(I))),
              null === b.aoColumns)
            )
              for (C = [], m = 0, p = g.length; m < p; m++) C.push(null);
            else C = b.aoColumns;
            for (m = 0, p = C.length; m < p; m++) f(I, g ? g[m] : null);
            if (
              (v(I, b.aoColumnDefs, C, function (t, e) {
                d(I, t, e);
              }),
              R.length)
            ) {
            ...
            g = function () {
              if (b.aaSorting === a) {
                var e = I.aaSorting;
                for (m = 0, p = e.length; m < p; m++)
                  e[m][1] = I.aoColumns[m].asSorting[0];
              }
              wt(I),
                j.bSort &&
                ...
                Nt(
                  ...
                  "aoDrawCallback",
                  function () {
                    (I.bSorted || "ssp" === Mt(I) || j.bDeferRender) && wt(I);
                  },
                  "sc"
                );
              ...
              if (
                (0 === n.length && (n = t("<thead/>").appendTo(T)),
                (I.nTHead = n[0]),
                0 === (n = T.children("tbody")).length &&
                  (n = t("<tbody/>").appendTo(T)),
                (I.nTBody = n[0]),
                0 === (n = T.children("tfoot")).length &&
                  e.length > 0 &&
                  ("" !== I.oScroll.sX || "" !== I.oScroll.sY) &&
                  (n = t("<tfoot/>").appendTo(T)),
                0 === n.length || 0 === n.children().length
                  ? T.addClass(F.sNoFooter)
                  : n.length > 0 &&
                    ((I.nTFoot = n[0]), W(I.aoFooter, I.nTFoot)),
                b.aaData)
              )
                for (m = 0; m < b.aaData.length; m++) y(I, b.aaData[m]);
              else
                (I.bDeferLoading || "dom" == Mt(I)) &&
                  D(I, t(I.nTBody).children("tr"));
            ...
            b.bStateSave
              ? ((j.bStateSave = !0),
                Nt(I, "aoDrawCallback", At, "state_save"),
                It(I, b, g))
              : g();
          }
        }),
    ...
    ue = function t(e, n) {
      if (Array.isArray(n)) for (var a = 0; a < n.length; a++) t(e, n[a]);
      else e.push(n);
      return e;
    };
  Array.isArray ||
  ...
  var ye = function e(n, a) {
    if (Array.isArray(n))
      return t.map(n, function (t) {
        return e(t, a);
      });
    if ("number" == typeof n) return [a[n]];
  ...
  Xt("tables()", function (t) {
    return t !== a && null !== t ? new Vt(ye(t, this.context)) : this;
  }),
    Xt("table()", function (t) {
  ...
  var De = function (t, e, n) {
    ...
    if ("ssp" == Mt(t)) k(t, e);
      ...
      r && 4 !== r.readyState && r.abort(),
        B(t, [], function (n) {
          I(t);
          for (var a = 0, r = (n = J(t, n)).length; a < r; a++) y(t, n[a]);
          k(t, e), ft(t, !1);
        });
    }
  };
    ...
    if (!0 === e) this.child.show();
      ...
      !(function e(n, a) {
        if (Array.isArray(n) || n instanceof t)
          for (var r = 0, l = n.length; r < l; r++) e(n[r], a);
        else
          n.nodeName && "tr" === n.nodeName.toLowerCase()
            ? i.push(n)
            : ((r = t("<tr><td></td></tr>").addClass(a)),
              (t("td", r).addClass(a).html(n)[0].colSpan = b(o)),
              i.push(r[0]));
      })(e, n),
        ...
        _: function (e, r, o, i, l, s) {
          ...
          !(function n(a, r) {
            ...
            for (i = 0, f = r.length; i < f; i++)
              if (((m = r[i]), Array.isArray(m)))
                n((b = t("<" + (m.DT_el || "div") + "/>").appendTo(a)), m);
              else {
                switch (((u = null), (c = m), (b = e.iTabIndex), m)) {
                  case "ellipsis":
                    a.append('<span class="ellipsis">&#x2026;</span>');
                    break;
                  case "first":
                    (u = h.sFirst), 0 === l && ((b = -1), (c = c + " " + S));
                    break;
                  case "previous":
                    (u = h.sPrevious), 0 === l && ((b = -1), (c = c + " " + S));
                    break;
                  case "next":
                    (u = h.sNext),
                      (0 !== s && l !== s - 1) || ((b = -1), (c = c + " " + S));
