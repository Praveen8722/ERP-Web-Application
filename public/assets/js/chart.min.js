...
!(function (t, e) {
    ...
    _resolveDataElementOptions: function (t, e) {
      ...
      if (((i = i || {}), V.isArray(c)))
        for (o = 0, s = c.length; o < s; ++o)
          f[(l = c[o])] = $([i[l], d[l], h[l]], g, e, p);
      else
        for (o = 0, s = (r = Object.keys(c)).length; o < s; ++o)
          f[(l = r[o])] = $([i[l], d[c[l]], d[l], h[l]], g, e, p);
  ...
  var At = et.extend({
      ...
      updateElement: function (t, e, n) {
        var i = this,
          ...
          h = n
            ...
            : o.getPixelForValue("object" == _typeof(u) ? u : NaN, e, d),
      ...
      setHoverStyle: function (t) {
        ...
        (t.$previousStyle = {
          ...
          (e.borderColor = Ct(n.hoverBorderColor, i(n.borderColor))),
          (e.borderWidth = Ct(n.hoverBorderWidth, n.borderWidth)),
    ...
    update: function (t) {
      ...
      if (m < It) {
        var b = l.rotation % It,
          ...
          S = (b <= Ft && x >= Ft) || x >= It + Ft,
          C = (b <= -Ft && x >= -Ft) || x >= Tt + Ft,
          P = b === -Tt || x >= Tt ? -1 : Math.min(y, y * p, k, k * p),
      ...
      var i = this,
        ...
        f =
          (n && s.animateRotate) || t.hidden
            ? 0
            : i.calculateCircumference(c.data[e]) * (o.circumference / It),
  ...
  var Ot = St.extend({
    ...
    Rt = V.valueOrDefault,
    zt = V.options.resolve,
    Nt = V.canvas._isPointInArea;
  function Bt(t, e) {
  ...
  var Vt = et.extend({
      ...
      updateElement: function (t, e, n) {
        ...
        (i = h.getPixelForValue("object" == _typeof(d) ? d : NaN, e, u)),
      ...
      _resolveDatasetElementOptions: function (t) {
        ...
        return (
          ...
          (o.steppedLine = zt([i.steppedLine, n.steppedLine, r.stepped])),
          (o.clip = Wt(Rt(n.clip, Et(e._xScale, e._yScale, o.borderWidth)))),
          o
        );
      },
  ...
  var jt = et.extend({
    ...
    _computeAngle: function (t) {
      ...
      return Ht([e.chart.options.elements.arc.angle, (2 * Math.PI) / n], r, t);
    },
  });
  ...
  var Yt = et.extend({
    ...
    updateElement: function (t, e, n) {
      ...
      (t._scale = o),
        ...
        (t._model = {
          ...
          borderColor: l.borderColor,
          borderWidth: l.borderWidth,
          tension: Ut(a.tension, u ? u.tension : 0),
          hitRadius: l.hitRadius,
        });
    },
    _resolveDatasetElementOptions: function () {
      ...
      return (
        (i.spanGaps = Ut(e.spanGaps, n.spanGaps)),
        (i.tension = Ut(e.lineTension, n.elements.line.tension)),
        i
      );
    },
    updateBezierControlPoints: function () {
  ...
  function re(t, e, n) {
    ...
    if (
      ((i = e.outerWidth - ae(o, t, "left", "right")),
      (a = e.outerHeight - ae(o, t, "top", "bottom")),
      i !== t.w || a !== t.h)
    )
      ...
      update: function (t, e, n) {
        if (t) {
          var i = t.options.layout || {},
            ...
            h = ee(
              { maxPadding: ee({}, a), w: r, h: o, x: a.left, y: a.top },
              a
            );
          !(function (t, e) {
            var n, i, a;
            ...
            V.each(s.chartArea, function (e) {
              var n = e.box;
              ee(n, t.chartArea), n.update(h.w, h.h);
            });
        }
      },
    },
  ...
  (V.addEvent = xe), (V.removeEvent = ye);
  var Me = we._enabled
      ? we
      : {
  ...
  function Le(t) {
    ...
    return {
      ...
      _bodyFontFamily: Ae(t.bodyFontFamily, e.defaultFontFamily),
      _bodyFontStyle: Ae(t.bodyFontStyle, e.defaultFontStyle),
      _bodyAlign: t.bodyAlign,
      bodyFontSize: Ae(t.bodyFontSize, e.defaultFontSize),
      bodySpacing: t.bodySpacing,
      titleFontColor: t.titleFontColor,
      _titleFontFamily: Ae(t.titleFontFamily, e.defaultFontFamily),
      _titleFontStyle: Ae(t.titleFontStyle, e.defaultFontStyle),
      titleFontSize: Ae(t.titleFontSize, e.defaultFontSize),
      _titleAlign: t.titleAlign,
      titleSpacing: t.titleSpacing,
      titleMarginBottom: t.titleMarginBottom,
      footerFontColor: t.footerFontColor,
      _footerFontFamily: Ae(t.footerFontFamily, e.defaultFontFamily),
      _footerFontStyle: Ae(t.footerFontStyle, e.defaultFontStyle),
      footerFontSize: Ae(t.footerFontSize, e.defaultFontSize),
  ...
  var ze = G.extend({
      ...
      getTitle: function () {
        var t = this,
          ...
          o = [];
        return (o = Ie(o, Fe(i))), (o = Ie(o, Fe(a))), Ie(o, Fe(r));
      },
      getBeforeBody: function () {
        return Re(this._options.callbacks.beforeBody.apply(this, arguments));
      },
      getBody: function (t, e) {
        ...
        return (
          V.each(t, function (t) {
            ...
            Ie(r.before, Fe(i.beforeLabel.call(n, t, e))),
              Ie(r.lines, i.label.call(n, t, e)),
              Ie(r.after, Fe(i.afterLabel.call(n, t, e))),
              a.push(r);
          }),
          a
        );
      ...
      getAfterBody: function () {
        return Re(this._options.callbacks.afterBody.apply(this, arguments));
      },
      getFooter: function () {
        var t = this,
          ...
          r = [];
        return (r = Ie(r, Fe(n))), (r = Ie(r, Fe(i))), Ie(r, Fe(a));
      },
      update: function (t) {
        var e,
          n,
        ...
        if (p.length) {
          ...
          var _ = [],
            k = [];
          y = Te[c.position].call(h, p, h._eventPosition);
          var w = [];
      ...
      drawTitle: function (t, e, n) {
        var i,
          ...
          s = o.length;
        if (s) {
          var l = De(e.rtl, e.x, e.width);
          for (
            t.x = Oe(e, e._titleAlign),
      ...
      drawFooter: function (t, e, n) {
        var i,
          ...
          o = r.length;
        if (o) {
          var s = De(e.rtl, e.x, e.width);
          for (
            t.x = Oe(e, e._footerAlign),
      ...
      merger: function (t, e, n, i) {
        if ("xAxes" === t || "yAxes" === t) {
          ...
          for (e[t] || (e[t] = []), a = 0; a < s; ++a)
            (o = n[t][a]),
              (r = Ee(o.type, "xAxes" === t ? "category" : "linear")),
              a >= e[t].length && e[t].push({}),
              !e[t][a].type || (o.type && o.type !== e[t][a].type)
                ? V.merge(e[t][a], [Pe.getScaleDefaults(r), o])
                : V.merge(e[t][a], o);
    ...
    return V.merge({}, [].slice.call(arguments), {
      merger: function (t, e, n, i) {
        ...
        "scales" === t
          ? (e[t] = We(a, r))
          : "scale" === t
          ? (e[t] = V.merge(a, [Pe.getScaleDefaults(r.type), r]))
          : V._merger(t, e, n, i);
      },
    });
  }
  function He(t) {
    ...
    V.each(t.scales, function (e) {
      ...
      (e = Ve(z.global, z[t.config.type], e)),
  ...
  V.extend(Ye.prototype, {
    construct: function (t, e) {
      ...
      e = (function (t) {
        ...
        return (
          ...
          (e.labels = e.labels || []),
          (t.options = Ve(z.global, z[t.type], t.options || {})),
          t
        );
      })(e);
      ...
      e.scales &&
        ...
        V.each(i, function (e) {
          ...
          if (r in n && n[r].type === o)
            ...
            var l = Pe.getScaleConstructor(o);
            if (!l) return;
    ...
    update: function (t) {
      ...
      if (
        ...
        i.updateLayout(),
          ...
          (i.lastActive = []),
          Ce.notify(i, "afterUpdate"),
          i._layers.sort(Ue("z", "_idx")),
          i._bufferedRender
            ? (i._bufferedRequest = {
                duration: t.duration,
                easing: t.easing,
    ...
    updateLayout: function () {
      ...
      !1 !== Ce.notify(t, "beforeLayout") &&
        ...
        Ce.notify(t, "afterScaleUpdate"),
        Ce.notify(t, "afterLayout"));
    },
    updateDatasets: function () {
      if (!1 !== Ce.notify(this, "beforeDatasetsUpdate")) {
        for (var t = 0, e = this.data.datasets.length; t < e; ++t)
          this.updateDataset(t);
        Ce.notify(this, "afterDatasetsUpdate");
      }
    },
    updateDataset: function (t) {
      var e = this.getDatasetMeta(t),
        n = { meta: e, index: t };
      !1 !== Ce.notify(this, "beforeDatasetUpdate", [n]) &&
        (e.controller._update(), Ce.notify(this, "afterDatasetUpdate", [n]));
    },
    render: function (t) {
      var e = this;
      (t && "object" == _typeof(t)) ||
      ...
      var n = e.options.animation,
        i = Ee(t.duration, n && n.duration),
        a = t.lazy;
      if (!1 !== Ce.notify(e, "beforeRender")) {
        var r = function (t) {
          Ce.notify(e, "afterRender"), V.callback(n && n.onComplete, [t], e);
        };
        if (n && i) {
          var o = new K({
            numSteps: i / 16.66,
    ...
    _getSortedDatasetMetas: function (t) {
      ...
      return i.sort(Ue("order", "index")), i;
    },
    ...
    drawDatasets: function (t) {
      var e, n;
      if (!1 !== Ce.notify(this, "beforeDatasetsDraw", [t])) {
        for (
        ...
        Ce.notify(this, "afterDatasetsDraw", [t]);
      }
    },
    drawDataset: function (t, e) {
      var n = { meta: t, index: t.index, easingValue: e };
      !1 !== Ce.notify(this, "beforeDatasetDraw", [n]) &&
        (t.controller.draw(e), Ce.notify(this, "afterDatasetDraw", [n]));
    },
    _drawTooltip: function (t) {
      var e = this.tooltip,
        n = { tooltip: e, easingValue: t };
      !1 !== Ce.notify(this, "beforeTooltipDraw", [n]) &&
        (e.draw(), Ce.notify(this, "afterTooltipDraw", [n]));
    },
  ...
  function on(t, e) {
    return V.extend(
      V.options._parseFont({
        fontFamily: tn(e.fontFamily, t.fontFamily),
        fontSize: tn(e.fontSize, t.fontSize),
        fontStyle: tn(e.fontStyle, t.fontStyle),
        lineHeight: tn(e.lineHeight, t.lineHeight),
      }),
      {
  ...
  function sn(t) {
    var e = on(t, t.minor);
    return { minor: e, major: t.major.enabled ? on(t, t.major) : e };
  }
  function ln(t) {
    var e,
      n,
  ...
  function un(t, e, n, i) {
    var a,
      ...
      s,
      l = tn(n, 0),
      u = Math.min(tn(i, t.length), t.length),
      d = 0;
    for (
  ...
  var dn = G.extend({
      ...
      !s._isVisible() || !u.display || h >= c || d <= 1 || !s.isHorizontal()
        ...
        : ((e = (t = s._getLabelSizes()).widest.width),
          ...
          e + 6 > (a = l.offset ? s.maxWidth / d : i / (d - 1)) &&
            ...
            (r = s.maxHeight - an(l.gridLines) - u.padding - rn(l.scaleLabel)),
            (o = Math.sqrt(e * e + n * n)),
            (f = V.toDegrees(
              Math.min(
    ...
    fit: function () {
      var t = this,
        ...
        u = t.isHorizontal();
      if (
        (u ? (e.width = t.maxWidth) : s && (e.width = an(o) + rn(r)),
        u ? s && (e.height = an(o) + rn(r)) : (e.height = t.maxHeight),
        a.display && s)
      ) {
        var d = sn(a),
          h = t._getLabelSizes(),
      ...
      return (
        e ||
          ((t._labelSizes = e =
            ...
            })(t.ctx, sn(t.options.ticks), t.getTicks(), t.longestTextCache)),
    ...
    _autoSkip: function (t) {
      ...
      if (
        ...
        for (e = 0, n = u - 1; e < n; e++) un(t, i, l[e], l[e + 1]);
        return (
          (a = u > 1 ? (h - d) / (u - 1) : null),
          un(t, i, V.isNullOrUndef(a) ? 0 : d - a, d),
          un(t, i, h, V.isNullOrUndef(a) ? t.length : h + a),
          ln(t)
        );
      }
      return un(t, i), ln(t);
    ...
    _computeGridLineItems: function (t) {
      var e,
        ...
        P = an(_),
        A = [],
        D = _.drawBorder ? en(_.lineWidth, 0, 0) : 0,
        T = D / 2,
        I = V._alignPixel,
        F = function (t) {
          return I(x, t, D);
    ...
    _drawGrid: function (t) {
      ...
      if (n.display) {
        var i,
          ...
          u = e.chart,
          d = V._alignPixel,
          h = n.drawBorder ? en(n.lineWidth, 0, 0) : 0,
          c =
        ...
        if (h) {
          var f,
            ...
            m,
            v = h,
            b = en(n.lineWidth, c.ticksLength - 1, 1),
            x = c.borderValue;
          e.isHorizontal()
            ? ((f = d(u, e.left, v) - v / 2),
              (g = d(u, e.right, b) + b / 2),
    ...
    _drawTitle: function () {
      ...
      if (i.display) {
        var a,
          r,
          o = tn(i.fontColor, z.global.defaultFontColor),
    ...
    fn = hn.extend({
      ...
      getPixelForValue: function (t, e, n) {
        var i,
          ...
          o = this;
        return (
          cn(e) || cn(n) || (t = o.chart.data.datasets[n].data[e]),
          cn(t) || (i = o.isHorizontal() ? t.x : t.y),
  ...
  var gn = V.noop,
      ...
      buildTicks: function () {
        var t = this,
          ...
          a = (t.ticks = (function (t, e) {
            ...
            if (p < 1e-14 && pn(d) && pn(h)) return [f, g];
            (r = Math.ceil(g / p) - Math.floor(f / p)) > u &&
              ...
              (a = Math.ceil(g / p) * p),
              s &&
                (!pn(d) && V.almostWhole(d / p, p / 1e3) && (i = d),
                !pn(h) && V.almostWhole(h / p, p / 1e3) && (a = h)),
              (r = (a - i) / p),
    ...
    vn = { position: "left", ticks: { callback: $e.formatters.linear } };
  function bn(t, e, n, i) {
    var a,
      r,
      o = t.options,
  ...
  var yn = mn.extend({
      determineDataLimits: function () {
        ...
        for (t = 0; t < d; ++t)
          (n = o[(e = s[t]).index].data), l ? bn(a, u, e, n) : xn(a, e, n);
        V.each(u, function (t) {
    ...
    _n = vn;
  yn._defaults = _n;
  var kn = V.valueOrDefault,
    wn = V.math.log10,
    Mn = { position: "left", ticks: { callback: $e.formatters.logarithmic } };
  function Sn(t, e) {
  ...
  var Cn = hn.extend({
        ...
        (t.min = Sn(e.min, t.min)),
          ...
          t.min === t.max &&
            (0 !== t.min && null !== t.min
              ...
              : ((t.min = 1), (t.max = 10))),
          null === t.min && (t.min = Math.pow(10, Math.floor(wn(t.max)) - 1)),
          null === t.max &&
            (t.max =
              0 !== t.min ? Math.pow(10, Math.floor(wn(t.min)) + 1) : 10),
          null === t.minNotZero &&
            (t.min > 0
              ? (t.minNotZero = t.min)
              : t.max < 1
        ...
        var t = this,
          ...
          a = (t.ticks = (function (t, e) {
            var n,
              i,
              a = [],
              r = kn(t.min, Math.pow(10, Math.floor(wn(e.min)))),
      ...
      _configure: function () {
        ...
        hn.prototype._configure.call(t),
          0 === e &&
            ...
            (n =
              kn(t.options.ticks.fontSize, z.global.defaultFontSize) /
              t._length)),
          (t._startValue = wn(e)),
          (t._valueOffset = n),
      ...
      getPixelForValue: function (t) {
        ...
        return (
          (t = +e.getRightValue(t)) > e.min &&
            t > 0 &&
            (n = (wn(t) - e._startValue) / e._valueRange + e._valueOffset),
    ...
    Pn = Mn;
  Cn._defaults = Pn;
  var An = V.valueOrDefault,
    Dn = V.valueAtIndexOrDefault,
    Tn = V.options.resolve,
    In = {
      display: !0,
      animate: !0,
      position: "chartArea",
  ...
  function Fn(t) {
    ...
    return e.display && t.display
      ? An(e.fontSize, z.global.defaultFontSize) + 2 * e.backdropPaddingY
      : 0;
  }
  ...
  var Bn = mn.extend({
      ...
      _drawGrid: function () {
        var t,
          ...
          o = r.gridLines,
          s = r.angleLines,
          l = An(s.lineWidth, o.lineWidth),
          u = An(s.color, o.color);
        if (
            ...
            (function (t) {
              ...
              for (var s = t.chart.data.labels.length - 1; s >= 0; s--) {
                var l = 0 === s ? a / 2 : 0,
                  ...
                  d = Dn(i.fontColor, s, z.global.defaultFontColor);
                e.fillStyle = d;
                var h = t.getIndexAngle(s),
                  c = V.toDegrees(h);
                (e.textAlign = On(c)),
                  zn(c, t._pointLabelSizes[s], u),
                  Rn(e, t.pointLabels[s], u, o.lineHeight);
              }
              e.restore();
            })(i),
          o.display &&
          ...
          for (
            a.save(),
              ...
              a.strokeStyle = u,
              a.setLineDash &&
                (a.setLineDash(Tn([s.borderDash, o.borderDash, []])),
                (a.lineDashOffset = Tn([
                  s.borderDashOffset,
                  o.borderDashOffset,
                  0,
      ...
      _drawLabels: function () {
        ...
        if (n.display) {
          var i,
            ...
            s = An(n.fontColor, z.global.defaultFontColor);
          e.save(),
            (e.font = o.string),
  ...
  function Qn(t, e, n, i) {
    var a,
      ...
      o,
      s = Yn.length;
    for (a = Yn.indexOf(t); a < s - 1; ++a)
      if (
        ((o = (r = Un[Yn[a]]).steps ? r.steps : qn),
  ...
  var ei = hn.extend({
    ...
    buildTicks: function () {
          ...
          "data" === c || ("auto" === c && "series" === f)
            ...
            : (function (t, e, n, i) {
                var a,
                  ...
                  o = t.options,
                  s = o.time,
                  l = s.unit || Qn(s.minUnit, e, n, i),
                  u = Vn([s.stepSize, s.unitStepSize, 1]),
      ...
      return (
        ...
        (i._unit =
          l.unit ||
          (s.autoSkip
            ? Qn(l.minUnit, i.min, i.max, h)
            : (function (t, e, n, i, a) {
                var r, o;
                for (r = Yn.length - 1; r >= Yn.indexOf(n); r--)
                  if (
                    ((o = Yn[r]),
                    Un[o].common && t._adapter.diff(a, i, o) >= e - 1)
                  )
                    return o;
        ...
        (i._majorUnit =
          s.major.enabled && "year" !== i._unit
            ? (function (t) {
                for (var e = Yn.indexOf(t) + 1, n = Yn.length; e < n; ++e)
                  if (Un[Yn[e]].common) return Yn[e];
              })(i._unit)
            : void 0),
        ...
        (i._offsets = (function (t, e, n, i, a) {
          ...
          return (
            a.offset &&
              ...
              ((r = Zn(t, "time", e[0], "pos")),
              (s =
                1 === e.length ? 1 - r : (Zn(t, "time", e[1], "pos") - r) / 2),
    ...
    tickFormatFunction: function (t, e, n, i) {
      var a = this._adapter,
        ...
        g = c ? h.major : h.minor,
        p = Vn([g.callback, g.userCallback, h.callback, h.userCallback]);
      return p ? p(f, e, n) : f;
    },
    ...
    _getLabelSize: function (t) {
      var e = this.options.ticks,
        ...
        a = Math.cos(i),
        r = Math.sin(i),
        o = Hn(e.fontSize, z.global.defaultFontSize);
    ...
    getLabelCapacity: function (t) {
      var e = this,
        ...
        r = e.tickFormatFunction(t, 0, ti(e, [t], e._majorUnit), a),
        o = e._getLabelSize(r),
  ...
  function li(t) {
    var e = t.fill,
      n = "dataset";
    return !1 === e ? null : (isFinite(e) || (n = "boundary"), ai[n](t));
  }
  function ui(t) {
    return t && !t.skip;
  }
        ...
        h && c
          ...
          : b &&
            ...
            (p
              ...
              : (di(t, m, v, b, x), (b = x = 0), (m = []), (v = [])));
    di(t, m, v, b, x), t.closePath(), (t.fillStyle = a), t.fill();
  }
  var ci = {
      id: "filler",
      afterDatasetsUpdate: function (t, e) {
        ...
        for (i = 0; i < o; ++i)
          (r = l[i]) &&
            ((r.fill = si(l, i, s)), (r.boundary = oi(r)), (r.mapper = li(r)));
      },
        ...
        for (n = l.length - 1; n >= 0; --n)
          (e = l[n].$filler) &&
            ...
            o &&
              ...
              hi(u, r, o, a, s, i._loop),
              V.canvas.unclipArea(u)));
      },
    },
    fi = V.rtl.getRtlAdapter,
    gi = V.noop,
    pi = V.valueOrDefault;
  function mi(t, e) {
  ...
  var vi = G.extend({
    ...
    draw: function () {
      ...
      if (e.display) {
        var d,
          h = fi(e.rtl, t.left, t.minSize.width),
          c = t.ctx,
  ...
  function bi(t, e) {
    var n = new vi({ ctx: t.ctx, options: e, chart: t });
      ...
      beforeUpdate: function (t) {
        ...
        e
          ? (V.mergeIf(e, z.global.legend),
            n ? (de.configure(t, n, e), (n.options = e)) : bi(t, e))
  ...
  function ki(t, e) {
    var n = new _i({ ctx: t.ctx, options: e, chart: t });
      ...
      beforeUpdate: function (t) {
        ...
        e
          ? (V.mergeIf(e, z.global.title),
            n ? (de.configure(t, n, e), (n.options = e)) : ki(t, e))
          : n && (de.removeBox(t, n), delete t.titleBlock);
      },
    };
  for (var Pi in ((wi.filler = Mi),
  (wi.legend = Si),
  (wi.title = Ci),
  (Ge.helpers = V),
  (function () {
  ...
  (Ge._adapters = Ze),
  (Ge.Animation = K),
  (Ge.animationService = Z),
  (Ge.controllers = Gt),
  (Ge.DatasetController = et),
  (Ge.defaults = z),
  (Ge.Element = G),
  (Ge.elements = bt),
  (Ge.Interaction = te),
  ...
  (Ge.Ticks = $e),
  (Ge.Tooltip = Be),
  Ge.helpers.each(ni, function (t, e) {
    Ge.scaleService.registerScaleType(e, t, t._defaults);
  }),
  wi))
    wi.hasOwnProperty(Pi) && Ge.plugins.register(wi[Pi]);
  Ge.platform.initialize();
  var Ai = Ge;
  return (
    "undefined" != typeof window && (window.Chart = Ge),
    (Ge.Chart = Ge),
    (Ge.Legend = wi.legend._element),
    (Ge.Title = wi.title._element),
    (Ge.pluginService = Ge.plugins),
    (Ge.PluginBase = Ge.Element.extend({})),
    (Ge.canvasHelpers = Ge.helpers.canvas),
    (Ge.layoutService = Ge.layouts),
    (Ge.LinearScaleBase = mn),
    Ge.helpers.each(
