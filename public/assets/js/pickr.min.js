...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function o(t, e, n, r) {
        ...
        try {
          for (a.s(); !(i = a.n()).done; ) {
            var c,
              l = i.value,
              s = _createForOfIteratorHelper(n);
            try {
              for (s.s(); !(c = s.n()).done; ) {
                var u = c.value;
                l[t](u, r, _objectSpread({ capture: !1 }, o));
              }
            } catch (t) {
              s.e(t);
            } finally {
      ...
      var i = o.bind(null, "addEventListener"),
        a = o.bind(null, "removeEventListener");
      function c(t) {
      ...
      function l(t) {
        ...
        return (function t(n) {
          var r =
            ...
            a = o ? (r[o] = {}) : r;
          i && (r[i] = n);
          for (var c = 0, l = Array.from(n.children); c < l.length; c++) {
            var s = l[c],
              u = e(s, ":arr"),
              p = t(s, u ? {} : a);
            u && (a[u] || (a[u] = [])).push(Object.keys(p).length ? p : s);
          }
          return r;
        })(c(t));
      }
      ...
      function u(t) {
        return t instanceof Element
          ...
          ? t.split(/>>/g).reduce(function (t, e, n, r) {
              return (
                (t = t.querySelector(e)), n < r.length - 1 ? t.shadowRoot : t
              );
            }, document)
          : null;
      }
      function p(t) {
        ...
        i(t, "focus", function () {
          return i(window, "wheel", n, { passive: !1 });
        }),
          i(t, "blur", function () {
      ...
      function w(t, e, n) {
        e /= 100;
        var r = ((2 * (e *= (n /= 100) < 0.5 ? n : 1 - n)) / (n + e)) * 100,
          o = 100 * (n + e);
      ...
      function k() {
        var t =
          ...
          i = {
            ...
            toHSLA: function () {
              var t = [].concat(_toConsumableArray(m(i.h, i.s, i.v)), [i.a]);
              return (
                (t.toString = o(t, function (t) {
                  return "hsla("
                    .concat(t[0], ", ")
            ...
            toRGBA: function () {
              var t = [].concat(_toConsumableArray(b(i.h, i.s, i.v)), [i.a]);
              return (
                (t.toString = o(t, function (t) {
                  return "rgba("
                    .concat(t[0], ", ")
        ...
        var e = {
              ...
              if (document.activeElement === n.wrapper) {
                ...
                if ("keydown" === r && (a || c || l || s)) {
                  ...
                  "v" === i
                    ...
                    : "h" === i
                    ? (u = a || c ? -1 : 1)
                    : ((p = a ? -1 : l ? 1 : 0), (u = s ? -1 : c ? 1 : 0)),
                    e.update(C(e.cache.x + 0.01 * u), C(e.cache.y + 0.01 * p)),
                    t.preventDefault();
                } else
                  o.startsWith("Arrow") &&
            ...
            _tapmove: function (t) {
              var n = e.options,
                ...
                o = n.lock,
                i = n.element,
                a = n.wrapper.getBoundingClientRect(),
                c = 0,
                l = 0;
              if (t) {
                ...
                (c = t ? (s || t).clientX : 0),
                  ...
                  (c -= a.left),
                  (l -= a.top);
              } else r && ((c = r.x * a.width), (l = r.y * a.height));
              "h" !== o &&
                (i.style.left = "calc("
            ...
            update: function () {
              ...
              "h" === e.options.lock && (n = t),
                e._tapmove({ clientX: o + a * t, clientY: i + c * n });
            },
            destroy: function () {
              var t = e.options,
                n = e._tapstart,
          ...
          o = e._keyboard;
        return (
          i([n.wrapper, n.element], "mousedown", r),
          i([n.wrapper, n.element], "touchstart", r, { passive: !1 }),
          i(document, ["keydown", "keyup"], o),
          e
        );
      }
      function O() {
      ...
      var L = (function () {
        function t(e) {
          ...
          _classCallCheck(this, t),
            ...
            (this.options = e =
              Object.assign(_objectSpread({}, t.DEFAULT_OPTIONS), e));
          var r = e,
            o = r.swatches,
            i = r.components,
            a = r.theme,
          ...
          var h = this._root,
            v = h.button,
            y = h.app;
          (this._nanopop = (function (t, e, n) {
            var r =
              "object" != _typeof(t) || t instanceof HTMLElement
                ? _objectSpread({ reference: t, popper: e }, n)
                : t;
            return {
              update: function () {
                var t =
                ...
                return (function (t, e, n) {
                  ...
                  var d,
                    ...
                    y = {
                      vs: f.left,
                      vm: f.left + f.width / 2 + -h.width / 2,
                      ve: f.left + f.width - h.width,
                      hs: f.top,
                      hm: f.bottom - f.height / 2 - h.height / 2,
                      he: f.bottom - h.height,
                    },
                    b = _slicedToArray(a.split("-"), 2),
                    m = b[0],
                    _ = b[1],
                    g = void 0 === _ ? "middle" : _,
                    w = l[m],
                    ...
                    S = o.bottom,
                    O = o.right,
                    E = _createForOfIteratorHelper(w);
                  try {
                    for (E.s(); !(d = E.n()).done; ) {
                      var L = d.value,
                        T = "t" === L || "b" === L,
                        ...
                        R = x[1],
                        B = _slicedToArray(
                          T ? [h.height, h.width] : [h.width, h.height],
                          2
                        ),
                        I = B[0],
                        D = B[1],
                        F = _slicedToArray(T ? [S, O] : [O, S], 2),
                        N = F[0],
                        M = F[1],
                        U = _slicedToArray(T ? [k, C] : [C, k], 2),
                        W = U[0],
                        K = U[1];
                      if (!(P < W || P + I > N)) {
                        var V,
                          z = _createForOfIteratorHelper(A);
                        try {
                          for (z.s(); !(V = z.n()).done; ) {
                            var X = V.value,
                              $ = y[(T ? "v" : "h") + X];
                  ...
                  return (e.style.left = u), (e.style.top = p), null;
                })(n, o, r);
              },
            };
          })(v, y, { margin: s })),
            v.setAttribute("role", "button"),
            v.setAttribute("aria-label", this._t("btn:toggle"));
          var b = this;
          requestAnimationFrame(function t() {
            if (!y.offsetWidth) return requestAnimationFrame(t);
            b.setColor(e.default),
              b._rePositioningPicker(),
              e.defaultRepresentation &&
                ((b._representation = e.defaultRepresentation),
                b.setColorRepresentation(b._representation)),
              e.showAlways && b.show(),
              (b._initializingActive = !1),
              b._emit("init");
          });
        }
        return (
          _createClass(t, [
                  ...
                  var e = t.options,
                    ...
                    p = l(
                      '\n      <div :ref="root" class="pickr">\n\n        '
                        ...
                        .concat(
                          s(Object.keys(n.interaction).length),
                          '>\n            <input :ref="result" class="pcr-result" type="text" spellcheck="false" '
                        )
                        .concat(s(n.interaction.input), ' aria-label="')
                        .concat(
                          u("aria:input"),
                    ...
                    d = p.interaction;
                  return (
                    d.options.find(function (t) {
                      return !t.hidden && !t.classList.add("active");
                    }),
                    (d.type = function () {
                      return d.options.find(function (t) {
            ...
            },
            {
              ...
              value: function () {
                var t = this,
                  ...
                  o = _slicedToArray(r.match(/^[vh]+$/g) ? r : [], 2),
                  i = o[0],
                  a = o[1],
                  c = function () {
                          ...
                          (this.element.style.background = p),
                            ...
                            a.comparison
                              ? a.useAsButton ||
                                e._lastColor ||
                                (s.style.color = p)
                              : ((i.button.style.color = p),
                                i.button.classList.remove("clear"));
                          var d,
                            f = o.toHEXA().toString(),
                            h = _createForOfIteratorHelper(e._swatchColors);
                          try {
                            for (h.s(); !(d = h.n()).done; ) {
                              var v = d.value,
                                y = v.el,
                                b = v.color;
                              y.classList[
                                f === b.toHEXA().toString() ? "add" : "remove"
                              ]("pcr-active");
                            }
                          } catch (t) {
                            h.e(t);
                    ...
                    opacity: S({
                      ...
                      onchange: function (t) {
                        if (n.opacity && n.palette) {
                          var r = c();
                          e._recalc && (r.a = Math.round(100 * t) / 100),
            ...
            },
            {
              ...
              value: function () {
                var t = this,
                  ...
                  n = this.options,
                  r = [
                    i(e.interaction.clear, "click", function () {
                    ...
                    i(e.interaction.save, "click", function () {
                      !t.applyColor() && !n.showAlways && t.hide();
                    }),
                    i(e.interaction.result, ["keyup", "input"], function (e) {
                      t.setColor(e.target.value, !0) &&
                        !t._initializingActive &&
                        t._emit("change", t._color),
                        e.stopImmediatePropagation();
                    }),
                    i(e.interaction.result, ["focus", "blur"], function (e) {
                ...
                if (n.adjustableNumbers) {
                  ...
                  p(e.interaction.result, function (e, n, r) {
                    var o = a[t.getColorRepresentation().toLowerCase()];
                    if (o) {
                      var i = o[r],
                        c = e + (i >= 100 ? 1e3 * n : n);
                      return c <= 0
                        ? 0
                        : Number((c < i ? c : i).toPrecision(3));
                    }
                    return e;
                  });
                }
                if (n.autoReposition && !n.inline) {
                  ...
                  r.push(
                    i(
                      ...
                      function () {
                        l.isOpen() &&
                          (n.closeOnScroll && l.hide(),
                          null === c
                            ? ((c = setTimeout(function () {
                                return (c = null);
                              }, 100)),
                              requestAnimationFrame(function t() {
                                l._rePositioningPicker(),
                ...
                var e = (function (t) {
                    ...
                    t: for (var o in n)
                      if ((e = n[o].exec(t))) {
                        ...
                        switch (o) {
                          case "cmyk":
                            var a = _slicedToArray(r(e), 5),
                              c = a[1],
                              l = a[2],
                              s = a[3],
                              u = a[4];
                            if (c > 100 || l > 100 || s > 100 || u > 100)
                              break t;
                            return { values: g(c, l, s, u), type: o };
                          case "rgba":
                            var p = _slicedToArray(r(e), 7),
                              d = p[3],
                              f = p[4],
                              h = p[5],
                              v = p[6];
                          ...
                          case "hexa":
                            var y = _slicedToArray(e, 2)[1];
                            (4 !== y.length && 3 !== y.length) ||
                              (y = y
                                .split("")
                                .map(function (t) {
                                  return t + t;
                            ...
                            var b = y.substring(0, 6),
                              m = y.substring(6);
                            return (
                              (m = m ? parseInt(m, 16) / 255 : void 0),
                              {
                                values: [].concat(_toConsumableArray(A(b)), [
                                  m,
                                ]),
                                a: m,
                                type: o,
                          ...
                          case "hsva":
                            ...
                            if (
                              ...
                              break t;
                            return { values: [L, T, P, x], a: x, type: o };
                        }
                      }
              ...
              value: function (t) {
                ...
                if (n) {
                  var r = this._swatchColors,
                    o = this._root,
                    a = k.apply(void 0, _toConsumableArray(n)),
                    l = c(
                      '<button type="button" style="color: '
                        .concat(a.toRGBA().toString(0), '" aria-label="')
                        .concat(this._t("btn:swatch"), '"/>')
                    );
                  return (
                    o.swatches.appendChild(l),
                    r.push({ el: l, color: a }),
                    this._eventBindings.push(
                      i(l, "click", function () {
                        e.setHSVA.apply(
                          e,
                          _toConsumableArray(a.toHSVA()).concat([!0])
                        ),
                          e._emit("swatchselect", a),
                          e._emit("change", a);
                      })
                    ),
                    !0
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  (n.lastColor.style.color = o),
                  this.options.useAsButton || (r.style.color = o),
                ...
                if (r) {
                  ...
                  if (c && !c.hidden) {
                    ...
                    try {
                      for (s.s(); !(l = s.n()).done; ) {
                        var u = l.value;
                        u.classList[u === c ? "add" : "remove"]("active");
                      }
                    } catch (t) {
                      s.e(t);
                    } finally {
