  ...
  !(function (t) {
      ...
      s = (function () {
        function i(e, o) {
          ...
          !(function (t, e) {
            ...
            (this._$element = e instanceof jQuery ? e : t(e)),
          ...
          t(this._config.doc.body).append(
            ...
            this._$modal
              ...
              .on("shown.bs.modal", function () {
                return (
                  s._toggleLoading(!0), s._handle(), s._config.onShown.call(s)
                );
              })
            ...
            this._$lightboxContainer
              ...
              .on("touchend", function () {
                (s._touchendX = event.changedTouches[0].screenX),
                  s._swipeGesure();
              });
        }
        return (
          ...
          e(
            ...
            [
              ...
              },
              {
                key: "navigateTo",
                value: function (e) {
                  if (e < 0 || e > this._$galleryItems.length - 1) return this;
              ...
              },
              {
                ...
                value: function (t) {
                  return 39 === (t = t || window.event).keyCode
                    ? this.navigateRight()
                    : 37 === t.keyCode
                    ? this.navigateLeft()
                    : void 0;
              ...
              },
              {
                ...
                value: function (t, e) {
                  var i = this._getYoutubeId(t),
                    o = t.indexOf("&") > 0 ? t.substr(t.indexOf("&")) : "",
                    a = this._$element.data("width") || 560,
                    s = this._$element.data("height") || a / (560 / 315);
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return this._showVideoIframe(t + "?autoplay=1", i, o, e);
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e, i) {
                  var o = this,
                    ...
                    n = this._$element.data("disableExternalCheck") || !1;
                  return (
                    this._toggleLoading(!1),
                    n || this._isExternal(e)
                      ? (i.html(
                          '<iframe src="' +
                            e +
              ...
              },
              {
                ...
                value: function (e, i) {
                  if (this._$galleryItems) {
                    var o = t(this._$galleryItems.get(e), !1);
                    if (void 0 !== o) {
                      var a = o.attr("data-remote") || o.attr("href");
                      return (
                        ("image" === o.attr("data-type") || this._isImage(a)) &&
                          this._preloadImage(a, !1),
                        i > 0 ? this._preloadImageByIndex(e + 1, i - 1) : void 0
                      );
                    }
                  }
                },
                    ...
                    i &&
                      ...
                      (s.onload = function () {
                        ...
                        return (
                          ...
                          e.css("width", "100%"),
                          i.html(e),
                          o._$modalArrows && o._$modalArrows.css("display", ""),
                          o._resize(s.width, s.height),
                          o._toggleLoading(!1),
                          o._config.onContentLoaded.call(o)
                        );
                      }),
                      (s.onerror = function () {
                        return (
                          o._toggleLoading(!1),
                          o._error(o._config.strings.fail + "  " + e)
                        );
                      })),
                    (s.src = e),
                    s
              ...
              },
              {
                ...
                value: function (e, i) {
                  ...
                  var o = e / i,
                    ...
                    n = this._config.doc.body.clientWidth > 575 ? 0 : 20,
                    l = Math.min(
                      e + a,
                      this._config.doc.body.clientWidth - s,
                      this._config.maxWidth
                    );
                  e + a > l ? ((i = (l - a - n) / o), (e = l)) : (e += a);
                  var r = 0,
                    d = 0;
                  this._footerIsShown &&
                    (d = this._$modalFooter.outerHeight(!0) || 55),
                    this._titleIsShown &&
                      (r = this._$modalHeader.outerHeight(!0) || 67);
                  var h =
                      this._padding.top +
                    ...
                    _ = Math.min(
                      i,
                      t(window).height() - h - g - r - d,
                      this._config.maxHeight - h - r - d
                    );
                  i > _ && (e = Math.ceil(_ * o) + a),
                    this._$lightboxContainer.css("height", _),
                    this._$modalDialog.css("flex", 1).css("maxWidth", e);
                  var c = this._$modal.data("bs.modal");
                  if (c)
                    try {
                      c._handleUpdate();
                    } catch (t) {
    ...
    (t.fn[i] = s._jQueryInterface),
      ...
      (t.fn[i].noConflict = function () {
        return (t.fn[i] = o), s._jQueryInterface;
      });
  })(jQuery);
})(jQuery);
