(() => {
  "use strict";
  var e = $("#developers-report-date-picker"),
    a = "ar" == languageName ? moment().lang("en") : moment();
  $(window).on("load", function () {
    loadDevelopersWorkReport(a.format("YYYY-MM-D  H:mm:ss"));
  }),
    e.on("apply.daterangepicker", function (e, a) {
      var t =
        "ar" == languageName
          ? a.startDate.lang("en").format("YYYY-MM-D  H:mm:ss")
          : a.startDate.format("YYYY-MM-D  H:mm:ss");
      loadDevelopersWorkReport(t);
    }),
    (window.cb = function (a) {
      e.find("span").html(a.format("MMM D, YYYY"));
    }),
    cb(a),
    e.daterangepicker(
      {
    ...
    (window.loadDevelopersWorkReport = function (e) {
      $.ajax({
        type: "GET",
    ...
    (window.prepareDeveloperWorkReport = function (e) {
      $("#developers-daily-work-report-container").html("");
      var a = e.data;
      if (0 === a.totalRecords)
        return (
          $("#developers-daily-work-report-container").empty(),
          $("#developers-daily-work-report-container").append(
      ...
      var t = document
        .getElementById("developers-daily-work-report")
        .getContext("2d");
      (t.canvas.style.height = "500px"), (t.canvas.style.width = "100%");
      new Chart(t, {
        type: "bar",
        data: {
          ...
          tooltips: {
            ...
            callbacks: {
              label: function (a, t) {
                ...
                s.innerHTML = t.datasets[a.datasetIndex].label;
                var o = s.value || "";
                return (
                  o && (o += ": "), o + (e = convertToTimeFormat(a.yLabel))
                );
              },
            },
          },
          scales: {
            yAxes: [{ scaleLabel: { display: !0, labelString: "Hours" } }],
          },
          legend: { display: !1 },
        },
      });
    }),
    (window.convertToTimeFormat = function (e) {
