  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function i(t) {
        ...
        return (
          (n = o(n)),
          (e = { left: 0, right: 0, top: 0, bottom: (r = o(r)) }),
          null === b &&
            (b = (function () {
              var t = m("<div><div></div></div>")
                  .css({
                    position: "absolute",
                    top: -1e3,
                    left: 0,
          ...
          b && "rtl" === t.css("direction") ? (e.left = n) : (e.right = n),
          e
        );
      }
      function o(t) {
      ...
      function u(t, e) {
        return t || e
          ? null == e
            ...
            : null == t
            ? 1
            : "string" === m.type(t) || "string" === m.type(e)
      ...
      (e.compensateScroll = function (t, e) {
        ...
        (e.disableCursor = function () {
          m("body").addClass("fc-not-allowed");
        }),
        (e.enableCursor = function () {
          m("body").removeClass("fc-not-allowed");
        }),
        (e.distributeHeight = function (t, e, n) {
          var i = Math.floor(e / t.length),
            o = Math.floor(e - i * (t.length - 1)),
            s = [],
            a = [],
            l = [],
            u = 0;
          r(t),
            t.each(function (e, n) {
              var r = e === t.length - 1 ? o : i,
                d = m(n).outerHeight(!0);
              d < r ? (s.push(n), a.push(d), l.push(m(n).height())) : (u += d);
            }),
            n &&
              ((e -= u),
              (i = Math.floor(e / s.length)),
              (o = Math.floor(e - i * (s.length - 1)))),
            m(s).each(function (t, e) {
              var n = t === s.length - 1 ? o : i,
                r = a[t],
                u = n - (r - l[t]);
              r < n && m(e).height(u);
            });
        }),
        (e.undistributeHeight = r),
        (e.matchCellWidths = function (t) {
          var e = 0;
          return (
            t.find("> *").each(function (t, n) {
              var r = m(n).outerWidth();
              r > e && (e = r);
            }),
            e++,
            t.width(e),
        ...
        (e.getClientRect = function (t, e) {
          var n = t.offset(),
            r = i(t),
            o = n.left + s(t, "border-left-width") + r.left - (e ? e.left : 0),
            a = n.top + s(t, "border-top-width") + r.top - (e ? e.top : 0);
          return {
            left: o,
      ...
      (e.isPrimaryMouseButton = function (t) {
        ...
        (e.computeGreatestUnit = d),
        (e.computeDurationGreatestUnit = function (t, e) {
          var n = d(t);
          return (
            "week" === n && "object" == _typeof(e) && e.days && (n = "day"), n
          );
        }),
        ...
        (e.divideDurationByDuration = function (t, e) {
          ...
          return p(t) || p(e)
            ...
            : ((n = t.asMonths()),
              (r = e.asMonths()),
              Math.abs(n) >= 1 && v(n) && Math.abs(r) >= 1 && v(r)
                ? n / r
                : t.asDays() / e.asDays());
        }),
        ...
        if (n)
          for (r = 0; r < n.length; r++) {
            for (i = n[r], o = [], s = e.length - 1; s >= 0; s--)
              if ("object" == _typeof((a = e[s][i]))) o.unshift(a);
              else if (void 0 !== a) {
                u[i] = a;
                break;
              }
          ...
          return (
            (t.invertRanges = function (e, n) {
              ...
              for (e.sort(r), i = 0; i < e.length; i++)
                (o = e[i]).startMs > a && s.push(new t(a, o.startMs)),
                  o.endMs > a && (a = o.endMs);
    ...
    function (t, e, n) {
      function r(t, e, n) {
        ...
        return (
          i.isMoment(p) || s.isNativeDate(p) || void 0 === p
            ? (c = i.apply(null, t))
            : ((r = !1),
              (u = !1),
              h
                ? a.test(p)
                  ? ((t = [(p += "-01")]), (r = !0), (u = !0))
                  : (d = l.exec(p)) && ((r = !d[5]), (u = !0))
                : o.isArray(p) && (u = !0),
              (c = e || r ? i.utc.apply(i, t) : i.apply(null, t)),
              r
      ...
      (e.default = p),
        ...
        (u.time = function (t) {
          ...
          (this._ambigTime = !1),
            i.isDuration(t) || i.isMoment(t) || (t = i.duration(t));
          var e = 0;
          return (
            i.isDuration(t) && (e = 24 * Math.floor(t.asDays())),
        ...
        (u.local = function (t) {
          return (
            d.local.call(this, this._ambigZone || t),
            (this._ambigTime = !1),
            (this._ambigZone = !1),
            this
          );
          ...
          return (
            ...
            (e.prototype.handleInteractionStart = function (e) {
              ...
              this.component.hitsNeeded(),
                ...
                e
                  ? ((i = r = { left: s.getEvX(e), top: s.getEvY(e) }),
                    o &&
            ...
            (e.prototype.handleDrag = function (e, n, i) {
              ...
              t.prototype.handleDrag.call(this, e, n, i),
                r((o = this.queryHit(s.getEvX(i), s.getEvY(i))), this.hit) ||
    ...
    function (t, e, n) {
      function r(t, n) {
        ...
        (r = e.localeOptionHash[t] || (e.localeOptionHash[t] = {})),
          n && (r = e.localeOptionHash[t] = l.mergeOptions([r, n])),
          (s = i(t)),
      ...
      (e.populateInstanceComputableOptions = function (t) {
        ...
        (e.datepickerLocale = function (t, n, r) {
          ...
          var s = o.datepicker;
          s &&
            ((s.regional[n] = s.regional[t] = r),
            (s.regional.en = s.regional[""]),
            s.setDefaults(r));
        }),
        (e.locale = r),
        (e.getMomentLocaleData = i),
        r("en", l.englishDefaults);
    },
    function (t, e, n) {
      Object.defineProperty(e, "__esModule", { value: !0 });
      var r = n(4);
        ...
        p = (function (t) {
          ...
          return (
            ...
            (e.prototype.reportEventResize = function (t, e, n, r) {
              ...
              var o = e.dateMutation.endDelta || e.dateMutation.startDelta;
              this.triggerEventResize(t, o, i, n, r);
            }),
    ...
    function (t, e, n) {
      ...
      function u(t) {
        ...
        for (e = 0; e < t.length; e++)
          (n = t[e]).token
            ? ((r = m[n.token.charAt(0)]), i.push(r ? r.unit : "second"))
            : n.maybe
            ? i.push.apply(i, u(n.maybe))
            : i.push(null);
        return i;
      }
      function d(t, e) {
        var n,
          r,
          i = [],
          o = p.oldMomentFormat(e, t).split(h);
        for (n = 0; n < o.length; n++)
          (r = o[n]).charAt(0) === f ? i.push(y[r.substring(1)](e)) : i.push(r);
        return i;
      }
      function c(t) {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 });
      var p = n(11);
      (p.newMomentProto.format = function () {
        return this._fullCalendar && arguments[0]
          ? i(this, arguments[0])
          : this._ambigTime
          ? p.oldMomentFormat(r(this), "YYYY-MM-DD")
          : this._ambigZone
          ? p.oldMomentFormat(r(this), "YYYY-MM-DD[T]HH:mm:ss")
          : this._fullCalendar
          ? p.oldMomentFormat(r(this))
          : p.oldMomentProto.format.apply(this, arguments);
      }),
        (p.newMomentProto.toISOString = function () {
          return this._ambigTime
            ? p.oldMomentFormat(r(this), "YYYY-MM-DD")
            : this._ambigZone
            ? p.oldMomentFormat(r(this), "YYYY-MM-DD[T]HH:mm:ss")
            : this._fullCalendar
            ? p.oldMomentProto.toISOString.apply(r(this), arguments)
            : p.oldMomentProto.toISOString.apply(this, arguments);
        });
      var h = "\v",
        f = "",
        g = "",
        ...
        y = {
          t: function (t) {
            return p.oldMomentFormat(t, "a").charAt(0);
          },
          T: function (t) {
            return p.oldMomentFormat(t, "A").charAt(0);
          },
      ...
      (e.formatDate = i),
        (e.formatRange = function (t, e, n, r, i) {
          return (
            (t = p.default.parseZone(t)),
            (e = p.default.parseZone(e)),
            (function (t, e, n, r, i) {
              var o,
                s,
                a,
                ...
                u = e.clone().stripZone(),
                p = n.clone().stripZone(),
                h = d(t.fakeFormatString, e),
                f = d(t.fakeFormatString, n),
                g = "",
                v = "",
                y = "",
                m = "",
                b = "";
              for (o = 0; o < l.length && (!l[o] || u.isSame(p, l[o])); o++)
                g += h[o];
              for (
                s = l.length - 1;
                s > o &&
              ...
              return (y || m) && (b = i ? m + r + y : y + r + m), c(g + b + v);
            })(
          ...
          return (
            ...
            (e.prototype.setProps = function (t) {
              var e,
                ...
                i = 0;
              for (e in t)
                ("object" != _typeof((n = t[e])) && n === this._props[e]) ||
                  ((r[e] = n), i++);
              if (i) {
          ...
          return (
            ...
            (t.prototype.build = function (t, e, n) {
              ...
              return (
                ...
                (d = r.duration(this.opt("minTime"))),
                (c = r.duration(this.opt("maxTime"))),
                (l = (l = this.adjustActiveRange(l, d, c)).intersect(i)) &&
                  (t = this.msToUtcMoment(l.constrainDate(t), p)),
            ...
            (t.prototype.buildRangeFromDuration = function (t, e, n, s) {
              ...
              return (
                ...
                n.as("days") <= 1 &&
                  ...
                  (d = this._view.skipHiddenDays(d, e)).startOf("day"),
                a(),
            ...
            (t.prototype.buildRangeFromDayCount = function (t, e, n) {
              ...
              if (s || -1 !== e) {
                (r = t.clone()),
                  s && r.startOf(s),
                  r.startOf("day"),
                  (i = (r = this._view.skipHiddenDays(r)).clone());
                do {
                  i.add(1, "day"), this._view.isHiddenDay(i) || a++;
                } while (a < n);
              } else {
                (i = t.clone().startOf("day").add(1, "day")),
                  (r = (i = this._view.skipHiddenDays(i, -1, !0)).clone());
                do {
          ...
          return (
            ...
            (e.prototype.computeRowLevelLimit = function (t) {
              ...
              for (n = 0; n < a.length; n++)
                if (
                  ((r = a.eq(n).removeClass("fc-limited")),
                  (o = 0),
              ...
              return !(
                ...
                !(function (t, e) {
                  var n,
                    ...
                    o = e.toLegacy();
                  for (n = 0; n < t.length; n++) {
                    if (!1 === (i = (r = t[n].eventInstance).def.getOverlap()))
                      return !1;
                    if ("function" == typeof i && !i(r.toLegacy(), o))
                      return !1;
                  }
                  return !0;
                })(s, i)
            ...
            (e.prototype.compoundTask = function (t) {
              ...
              if (t.namespace && "destroy" === t.type)
                for (e = r.length - 1; e >= 0; e--)
                  if ((n = r[e]).namespace === t.namespace)
                    switch (n.type) {
                      case "init":
                        i = !1;
                      case "add":
          ...
          return (
            ...
            (t.prototype.initialRender = function () {
              ...
              e.addClass("fc"),
                e.on("click.fc", "a[data-goto]", function (e) {
                  var n = i(e.currentTarget).data("goto"),
                    r = t.moment(n.date),
                    o = n.type,
                    a = t.view.opt(
                      "navLink" + s.capitaliseFirstLetter(o) + "Click"
                    );
                  "function" == typeof a
                    ? a(r, e)
                    : ("string" == typeof a && (o = a), t.zoomTo(r, o));
                }),
                this.optionsManager.watch(
                  "settingTheme",
                  ["?theme", "?themeSystem"],
                  function (n) {
                    var r = new (I.getThemeSystemClass(
            ...
            (t.prototype.moment = function () {
              ...
              return (
                "local" === this.opt("timezone")
                  ? (n = y.default.apply(null, t)).hasTime() && n.local()
                  : (n =
            ...
            (t.prototype.removeEvents = function (t) {
              ...
              if (null == t) n.removeAllEventDefs();
                ...
                for (e in (n.freeze(), o)) n.removeEventDefsById(e);
                n.thaw();
              }
            }),
    ...
    function (t, e, n) {
      function r(t) {
        ...
        return (
          ...
          (e = t.data(l + "event") || null) &&
            (null ==
              (n = (e = "object" == _typeof(e) ? o.extend({}, e) : {}).start) &&
              (n = e.time),
            (r = e.duration),
            (i = e.stick),
            delete e.start,
          ...
          null == i && (i = t.data(l + "stick")),
          {
            ...
            duration: (r = null != r ? s.duration(r) : null),
            stick: (i = Boolean(i)),
          }
        );
      }
      ...
      (e.default = g), d.default.mixInto(g), (a.dataAttrPrefix = "");
    },
    function (t, e, n) {
      Object.defineProperty(e, "__esModule", { value: !0 });
      var r = n(2),
    ...
    function (t, e, n) {
      ...
      function o(t) {
        ...
        if (void 0 === t.forwardPressure) {
          for (e = 0; e < r.length; e++)
            o((n = r[e])), (i = Math.max(i, 1 + n.forwardPressure));
          t.forwardPressure = i;
        }
      }
      function s(t, e, n) {
        ...
        d = (function (t) {
          ...
          return (
            ...
            (e.prototype.computeFgSegHorizontals = function (t) {
              var e, n, s;
              if ((this.sortEventSegs(t), i((e = r(t))), (n = e[0]))) {
