(() => {
  ...
  $(document).ready(function () {
    $("#currencyType").select2({ width: "100%" });
  }),
    $(document).on("submit", ".settings", function () {
      var e = jQuery(this).find(".save-btn");
      e.button("loading"),
        $(".settings")
          .find("input")
          .each(function () {
            if ($(this).prop("required") && 0 === $(this).val().length)
              return e.button("reset"), !1;
          });
    }),
    $(document).on("change", "#appLogo", function () {
      isValidFile($(this), "#validationErrorsBox") &&
    ...
    (window.isValidFile = function (e, i) {
      var t = $(e).val().split(".").pop().toLowerCase();
      return (
        -1 != $.inArray(t, ["gif", "png", "jpg", "jpeg"]) ||
        ($(e).val(""),
        $(i).html("The image must be a file of type: jpeg, jpg, png.").show(),
        setTimeout(function () {
    ...
    (window.displayPhoto = function (e, i) {
      var t = !0;
      if (e.files && e.files[0]) {
        ...
        (o.onload = function (e) {
          ...
          (o.src = e.target.result),
            (o.onload = function () {
              $(i).attr("src", e.target.result), (t = !0);
            });
        }),
          t && (o.readAsDataURL(e.files[0]), $(i).show());
      }
    }),
    $(document).on("change", "#favicon", function () {
      $("#validationErrorsBox").addClass("d-none"),
        isValidFavicon($(this), "#validationErrorsBox") &&
          displayFavicon(this, "#faviconPreview");
    }),
    (window.isValidFavicon = function (e, i) {
      var t = $(e).val().split(".").pop().toLowerCase();
      return -1 == $.inArray(t, ["gif", "png", "ico"])
        ? ($(e).val(""),
          $(i).removeClass("d-none"),
          $(i).html("The image must be a file of type: gif, ico, png.").show(),
          setTimeout(function () {
            $("#validationErrorsBox").delay(5e3).slideUp(300);
          }),
          !1)
    ...
    (window.displayFavicon = function (e, i) {
      var t = !0;
      if (e.files && e.files[0]) {
        var o = new FileReader();
        (o.onload = function (e) {
          ...
          (o.src = e.target.result),
            (o.onload = function () {
              if (
                !(
                  (16 == o.height && 16 == o.width) ||
                  (32 == o.height && 32 == o.width)
                )
              )
                return (
                  $("#favicon").val(""),
    ...
    $(document).on("keyup", "#workingDays", function () {
      $(this).val() > 31 && $(this).val(31);
    }),
    $(document).on("keyup", "#workingHours", function () {
      $(this).val() > 24 && $(this).val(24);
    }),
    $(document).on("click", ".save-btn-invoice", function () {
      jQuery(this).button("loading"), $(".invoice-settings").submit();
    }),
    $(document).ready(function () {
