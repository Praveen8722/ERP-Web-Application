!(function (e, a) {
  ...
  function y(e, a) {
    var t, s, n;
    if (
      (_(a._isAMomentObject) || (e._isAMomentObject = a._isAMomentObject),
      _(a._i) || (e._i = a._i),
      _(a._f) || (e._f = a._f),
      _(a._l) || (e._l = a._l),
      _(a._strict) || (e._strict = a._strict),
      _(a._tzm) || (e._tzm = a._tzm),
      _(a._isUTC) || (e._isUTC = a._isUTC),
      _(a._offset) || (e._offset = a._offset),
      _(a._pf) || (e._pf = M(a)),
      _(a._locale) || (e._locale = a._locale),
      0 < L.length)
    )
      for (t = 0; t < L.length; t++) _((n = a[(s = L[t])])) || (e[s] = n);
    return e;
  }
  function f(e) {
    y(this, e),
  ...
  function D(e, a) {
    ...
    return m(function () {
      if ((null != t.deprecationHandler && t.deprecationHandler(null, e), s)) {
        for (var n, r, _ = [], i = 0; i < arguments.length; i++) {
          if (((n = ""), "object" == typeof arguments[i])) {
            for (r in ((n += "\n[" + i + "] "), arguments[0]))
              d(arguments[0], r) && (n += r + ": " + arguments[0][r] + ", ");
            n = n.slice(0, -2);
          } else n = arguments[i];
          _.push(n);
        }
    ...
    return e.isValid()
      ? ((a = E(a, e.localeData())),
        (O[a] =
          O[a] ||
          (function (e) {
            for (var a, t = e.match(j), s = 0, n = t.length; s < n; s++)
              P[t[s]]
                ? (t[s] = P[t[s]])
                : (t[s] = (a = t[s]).match(/\[[\s\S]/)
                    ? a.replace(/^\[|\]$/g, "")
  ...
  function V(e, a) {
    return function (s) {
      return null != s
        ? (K(this, e, s), t.updateOffset(this, a), this)
        : B(this, e);
    };
  }
  function B(e, a) {
  ...
  (ye = Array.prototype.indexOf
    ...
    Le(["MMM", "MMMM"], function (e, a, t, s) {
      ...
      null != n ? (a[1] = n) : (M(t).invalidMonth = e);
    });
  var pe =
  ...
  function be(e) {
    return null != e
      ? (we(this, e), t.updateOffset(this, !0), this)
      : B(this, "Month");
  }
  function ve() {
    function e(e, a) {
  ...
  W("Y", 0, 0, function () {
    ...
    Le("YYYY", function (e, a) {
      a[0] = 2 === e.length ? t.parseTwoDigitYear(e) : G(e);
    }),
    Le("YY", function (e, a) {
  ...
  function xe(e, a, t) {
    var s = 7 + a - t;
    return s - ((7 + je(e, 0, s).getUTCDay() - a) % 7) - 1;
  }
  function Oe(e, a, t, s, n) {
    var d,
      r = 1 + 7 * (a - 1) + ((7 + t - s) % 7) + xe(e, s, n),
      _ =
        r <= 0
          ? He((d = e - 1)) + r
          : r > He(e)
  ...
  function Pe(e, a, t) {
    ...
    return (
      r < 1
        ? (s = r + We((n = e.year() - 1), a, t))
        : r > We(e.year(), a, t)
        ? ((s = r - We(e.year(), a, t)), (n = e.year() + 1))
        : ((n = e.year()), (s = r)),
      { week: s, year: n }
    );
  }
  ...
  var Ee = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split(
      "_"
    ),
  ...
  function Ce() {
    ...
    for (var a, t, s, n, d = [], r = [], _ = [], i = [], u = 0; u < 7; u++)
      (a = l([2e3, 1]).day(u)),
  ...
  W("H", ["HH", 2], 0, "hour"),
    ...
    W("hmm", 0, 0, function () {
      return "" + Ie.apply(this) + S(this.minutes(), 2);
    }),
    W("hmmss", 0, 0, function () {
      return "" + Ie.apply(this) + S(this.minutes(), 2) + S(this.seconds(), 2);
    }),
    W("Hmm", 0, 0, function () {
    ...
    Le(["h", "hh"], function (e, a, t) {
      (a[3] = G(e)), (M(t).bigHour = !0);
    }),
    Le("hmm", function (e, a, t) {
      var s = e.length - 2;
      (a[3] = G(e.substr(0, s))), (a[4] = G(e.substr(s))), (M(t).bigHour = !0);
    }),
    ...
    Le("Hmm", function (e, a, t) {
      var s = e.length - 2;
      (a[3] = G(e.substr(0, s))), (a[4] = G(e.substr(s)));
    }),
    Le("Hmmss", function (e, a, t) {
      var s = e.length - 4,
        n = e.length - 2;
  ...
  function ea(e, a) {
    ...
    if (((a.abbr = e), null != qe[e]))
      ...
      if (null != qe[a.parentLocale]) s = qe[a.parentLocale]._config;
        ...
        if (null == (t = Qe(a.parentLocale)))
          return (
            Ze[a.parentLocale] || (Ze[a.parentLocale] = []),
            Ze[a.parentLocale].push({ name: e, config: a }),
            null
          );
        s = t._config;
      }
  ...
  function aa(e) {
    ...
    return (function (e) {
      for (var a, t, s, n, d = 0; d < e.length; ) {
        for (
          a = (n = $e(e[d]).split("-")).length,
            t = (t = $e(e[d + 1])) ? t.split("-") : null;
          0 < a;
      ...
      t &&
        ...
        ((a =
          t[1] < 0 || 11 < t[1]
            ...
            ? 6
            : -1),
        M(e)._overflowDayOfYear && (a < 0 || 2 < a) && (a = 2),
        M(e)._overflowWeeks && -1 === a && (a = 7),
        M(e)._overflowWeekday && -1 === a && (a = 8),
        (M(e).overflow = a)),
      e
    );
  }
  ...
  function ma(e) {
    var a,
      ...
      r,
      _ = e._i,
      i = sa.exec(_) || na.exec(_);
    if (i) {
      for (M(e).iso = !0, a = 0, t = ra.length; a < t; a++)
        if (ra[a][1].exec(i[1])) {
          (n = ra[a][0]), (s = !1 !== ra[a][2]);
          break;
        }
      ...
      if (i[4]) {
        if (!da.exec(i[4])) return void (e._isValid = !1);
        r = "Z";
      }
      (e._f = n + (d || "") + (r || "")), ca(e);
    } else e._isValid = !1;
    ...
    if (d) {
      if (
        ((s = a =
          ...
          })(d[4], d[3], d[2], d[5], d[6], d[7])),
        (n = e),
        (t = d[1]) &&
          Fe.indexOf(t) !== new Date(s[0], s[1], s[2]).getDay() &&
          ((M(n).weekdayMismatch = !0), !void (n._isValid = !1)))
      )
        return;
      (e._a = a),
  ...
  function ha(e) {
    ...
    if (!e._d) {
      for (
          ...
          e._w &&
            ...
            (function (e) {
              ...
              null != (a = e._w).GG || null != a.W || null != a.E
                ? ((d = 1),
                  (r = 4),
                  (t = Ma(a.GG, e._a[0], Pe(ya(), 1, 4).year)),
                  (s = Ma(a.W, 1)),
                  ((n = Ma(a.E, 1)) < 1 || 7 < n) && (i = !0))
                : ((d = e._locale._week.dow),
                  (r = e._locale._week.doy),
                  (u = Pe(ya(), d, r)),
                  (t = Ma(a.gg, e._a[0], u.year)),
                  (s = Ma(a.w, u.week)),
                  null != a.d
                    ? ((n = a.d) < 0 || 6 < n) && (i = !0)
                    : null != a.e
        ...
        e._a[a] = u[a] = n[a];
      for (; a < 7; a++)
        e._a[a] = u[a] = null == e._a[a] ? (2 === a ? 1 : 0) : e._a[a];
      24 === e._a[3] &&
        0 === e._a[4] &&
        0 === e._a[5] &&
        0 === e._a[6] &&
    ...
    if (e._f !== t.ISO_8601)
      if (e._f !== t.RFC_2822) {
        ...
        for (
          ...
          (s = h[c]),
            (a = (o.match(Me(s, e)) || [])[0]) &&
              (0 < (n = o.substr(0, o.indexOf(a))).length &&
                M(e).unusedInput.push(n),
              (o = o.slice(o.indexOf(a) + a.length)),
              (l += a.length)),
            P[s]
              ? (a ? (M(e).empty = !1) : M(e).unusedTokens.push(s),
                (_ = s),
                (u = e),
                null != (i = a) && d(ce, _) && ce[_](i, u._a, u, _))
              : e._strict && !a && M(e).unusedTokens.push(s);
        (M(e).charsLeftOver = m - l),
          ...
          null !== (r = M(e).era) &&
            (e._a[0] = e._locale.erasConvertYear(r, e._a[0])),
          ha(e),
          ta(e);
      } else la(e);
    else ma(e);
  ...
  function Ya(e, a, t, d, _) {
    ...
    return (
      ...
      (u._useUTC = u._isUTC = _),
      (u._l = t),
      (u._i = e),
      (u._f = a),
      (u._strict = d),
      (i = new f(ta(La(u))))._nextDay && (i.add(1, "d"), (i._nextDay = void 0)),
      i
    );
  }
  function ya(e, a, t, s) {
  ...
  function Ta(e) {
    ...
    (this._isValid = (function (e) {
      var a,
        ...
        s = !1;
      for (a in e)
        if (d(e, a) && (-1 === ye.call(Da, a) || (null != e[a] && isNaN(e[a]))))
          return !1;
      for (t = 0; t < Da.length; ++t)
        if (e[Da[t]]) {
          if (s) return !1;
          parseFloat(e[Da[t]]) !== G(e[Da[t]]) && (s = !0);
        }
      return !0;
    })(a)),
      (this._milliseconds = +m + 1e3 * o + 6e4 * u + 1e3 * i * 60 * 60),
      (this._days = +_ + 7 * r),
  ...
  function Sa(e, a) {
    ...
    return a._isUTC
      ? ((s = a.clone()),
        (n = (p(e) || u(e) ? e.valueOf() : ya(e).valueOf()) - s.valueOf()),
    ...
    return (
      ga(e)
        ...
        : "object" == typeof r &&
          ...
          ((n = (function (e, a) {
            ...
            return e.isValid() && a.isValid()
              ? ((a = Sa(a, e)),
                e.isBefore(a)
                  ? (t = Ea(e, a))
                  : (((t = Ea(a, e)).milliseconds = -t.milliseconds),
                    (t.months = -t.months)),
                t)
          ...
          (r.M = n.months)),
      (s = new Ta(r)),
      ga(e) && d(e, "_locale") && (s._locale = e._locale),
      ga(e) && d(e, "_isValid") && (s._isValid = e._isValid),
      s
    );
  }
  function Aa(e, a) {
  ...
  function za(e, a, s, n) {
    ...
    e.isValid() &&
      ((n = null == n || n),
      _ && we(e, B(e, "Month") + _ * s),
      r && K(e, "Date", B(e, "Date") + r * s),
      d && e._d.setTime(e._d.valueOf() + d * s),
      n && t.updateOffset(e, r || _));
  }
  (Wa.fn = Ta.prototype),
    (Wa.invalid = function () {
      return Wa(NaN);
  ...
  function Ca(e) {
    return (
      ...
      (function (e) {
        ...
        for (a = 0; a < _.length; a += 1) s = s || d(e, _[a]);
        return t && s;
      })(e) ||
      null == e
    );
  ...
  function Ia(e, a) {
    if (e.date() < a.date()) return -Ia(a, e);
  ...
  function Qa() {
    for (
      ...
      a.push(he(n[d].name)),
        e.push(he(n[d].abbr)),
        t.push(he(n[d].narrow)),
        s.push(he(n[d].name)),
        s.push(he(n[d].abbr)),
        s.push(he(n[d].narrow));
  ...
  for (st = "S"; st.length <= 9; st += "S") Le(st, rt);
  (nt = V("Milliseconds", !1)),
    W("z", 0, 0, "zoneAbbr"),
    W("zz", 0, 0, "zoneName");
  var _t = f.prototype;
  ...
  (_t.add = Na),
    (_t.calendar = function (e, a) {
      ...
      var s = e || ya(),
        _ = Sa(s, this).startOf("day"),
        i = t.calendarFormat(this, _) || "sameElse",
        u = a && (b(a[i]) ? a[i].call(this, s) : a[i]);
      return this.format(u || this.localeData().calendar(i, this, ya(s)));
    }),
    (_t.clone = function () {
      return new f(this);
    }),
    (_t.diff = function (e, a, t) {
      var s, n, d;
      if (!this.isValid()) return NaN;
      if (!(s = Sa(e, this)).isValid()) return NaN;
      ...
      switch (((s = this._isUTC ? Za : qa), e)) {
        ...
        case "hour":
          (a = this._d.valueOf()),
            (a +=
              36e5 -
              Ka(a + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5) -
              1);
          break;
        case "minute":
          (a = this._d.valueOf()), (a += 6e4 - Ka(a, 6e4) - 1);
          break;
        case "second":
          (a = this._d.valueOf()), (a += 1e3 - Ka(a, 1e3) - 1);
      }
    ...
    (_t.from = function (e, a) {
      return this.isValid() && ((p(e) && e.isValid()) || ya(e).isValid())
    ...
    (_t.isSameOrAfter = function (e, a) {
      return this.isSame(e, a) || this.isAfter(e, a);
    }),
    (_t.isSameOrBefore = function (e, a) {
    ...
    (_t.startOf = function (e) {
      ...
      switch (((s = this._isUTC ? Za : qa), e)) {
        ...
        case "hour":
          (a = this._d.valueOf()),
            (a -= Ka(a + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5));
          break;
        case "minute":
          (a = this._d.valueOf()), (a -= Ka(a, 6e4));
          break;
        case "second":
          (a = this._d.valueOf()), (a -= Ka(a, 1e3));
      }
      return this._d.setTime(a), t.updateOffset(this, !0), this;
    }),
    (_t.subtract = Ja),
    ...
    "undefined" != typeof Symbol &&
      null != Symbol.for &&
      (_t[Symbol.for("nodejs.util.inspect.custom")] = function () {
    ...
    (_t.eraYear = function () {
      for (
        var e, a, s = this.localeData().eras(), n = 0, d = s.length;
        n < d;
        ++n
      )
        if (
          ((e = s[n].since <= s[n].until ? 1 : -1),
          (a = this.clone().startOf("day").valueOf()),
          (s[n].since <= a && a <= s[n].until) ||
            (s[n].until <= a && a <= s[n].since))
        )
          return (this.year() - t(s[n].since).year()) * e + s[n].offset;
      return this.year();
    }),
    (_t.year = Se),
    (_t.isLeapYear = function () {
      return I(this.year());
    }),
    ...
    (_t.hour = _t.hours = Be),
    (_t.minute = _t.minutes = tt),
    (_t.second = _t.seconds = dt),
    (_t.millisecond = _t.milliseconds = nt),
    (_t.utcOffset = function (e, a, s) {
      var n,
        d = this._offset || 0;
      if (!this.isValid()) return null != e ? this : NaN;
      if (null == e) return this._isUTC ? d : ja(this);
      if ("string" == typeof e) {
        if (null === (e = Ha(oe, e))) return this;
      } else Math.abs(e) < 16 && !s && (e *= 60);
      return (
        !this._isUTC && a && (n = ja(this)),
        (this._offset = e),
        (this._isUTC = !0),
        null != n && this.add(n, "m"),
        d !== e &&
          (!a || this._changeInProgress
            ? za(this, Wa(e - d, "m"), 1, !1)
    ...
    (_t.isUtc = xa),
    (_t.isUTC = xa),
    (_t.zoneAbbr = function () {
      return this._isUTC ? "UTC" : "";
    }),
    (_t.zoneName = function () {
      return this._isUTC ? "Coordinated Universal Time" : "";
    }),
    (_t.dates = D("dates accessor is deprecated. Use date instead.", at)),
    (_t.months = D("months accessor is deprecated. Use month instead", be)),
    (_t.years = D("years accessor is deprecated. Use year instead", Se)),
    (_t.zone = D(
  ...
  function mt(e, a, t) {
    if ((i(e) && ((a = e), (e = void 0)), (e = e || ""), null != a))
      return ot(e, a, t, "month");
    for (var s = [], n = 0; n < 12; n++) s[n] = ot(e, n, t, "month");
    return s;
  }
  function lt(e, a, t, s) {
    "boolean" == typeof e
    ...
    for (n = 0; n < 7; n++) _[n] = ot(a, (n + r) % 7, s, "day");
    return _;
  }
  (ut.calendar = function (e, a, t) {
    ...
    (ut.preparse = it),
    (ut.postformat = it),
    (ut.relativeTime = function (e, a, t, s) {
      var n = this._relativeTime[t];
      return b(n) ? n(e, a, t, s) : n.replace(/%d/i, e);
    }),
    (ut.pastFuture = function (e, a) {
    ...
    (ut.set = function (e) {
      var a, t;
      for (t in e)
        d(e, t) && (b((a = e[t])) ? (this[t] = a) : (this["_" + t] = a));
      (this._config = e),
    ...
    (ut.eras = function (e, a) {
      for (
        var s, n = this._eras || aa("en")._eras, d = 0, r = n.length;
        d < r;
        ++d
      ) {
        ...
        switch (typeof n[d].until) {
          case "undefined":
            ...
            break;
          case "string":
            (s = t(n[d].until).startOf("day").valueOf()),
              (n[d].until = s.valueOf());
        }
      }
      return n;
    }),
    (ut.erasParse = function (e, a, t) {
      var s,
        n,
        d,
        r,
    ...
    (ut.erasConvertYear = function (e, a) {
      var s = e.since <= e.until ? 1 : -1;
      return void 0 === a
        ? t(e.since).year()
        : t(e.since).year() + (a - e.offset) * s;
    }),
    (ut.erasAbbrRegex = function (e) {
      return (
        d(this, "_erasAbbrRegex") || Qa.call(this),
        e ? this._erasAbbrRegex : this._erasRegex
      );
    }),
    (ut.erasNameRegex = function (e) {
      return (
        d(this, "_erasNameRegex") || Qa.call(this),
        e ? this._erasNameRegex : this._erasRegex
      );
    }),
    (ut.erasNarrowRegex = function (e) {
      return (
        d(this, "_erasNarrowRegex") || Qa.call(this),
        e ? this._erasNarrowRegex : this._erasRegex
      );
    }),
    (ut.months = function (e, a) {
      return e
        ? s(this._months)
    ...
    (ut.monthsRegex = function (e) {
      return this._monthsParseExact
        ? (d(this, "_monthsRegex") || ve.call(this),
          e ? this._monthsStrictRegex : this._monthsRegex)
        : (d(this, "_monthsRegex") || (this._monthsRegex = ge),
    ...
    (ut.monthsShortRegex = function (e) {
      return this._monthsParseExact
        ...
        : (d(this, "_monthsShortRegex") || (this._monthsShortRegex = Te),
    ...
    (ut.weekdaysParse = function (e, a, t) {
      var s, n, d;
    ...
    (ut.weekdaysRegex = function (e) {
      return this._weekdaysParseExact
        ? (d(this, "_weekdaysRegex") || Ce.call(this),
          e ? this._weekdaysStrictRegex : this._weekdaysRegex)
        : (d(this, "_weekdaysRegex") || (this._weekdaysRegex = Ne),
          this._weekdaysStrictRegex && e
            ? this._weekdaysStrictRegex
            : this._weekdaysRegex);
    }),
    (ut.weekdaysShortRegex = function (e) {
      return this._weekdaysParseExact
        ? (d(this, "_weekdaysRegex") || Ce.call(this),
    ...
    (ut.weekdaysMinRegex = function (e) {
      return this._weekdaysParseExact
        ? (d(this, "_weekdaysRegex") || Ce.call(this),
          e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
        : (d(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Re),
  ...
  var St = Ht("milliseconds"),
    ...
    At = Ht("years"),
    Et = Math.round,
    Ft = { ss: 44, s: 45, m: 45, h: 22, d: 26, w: null, M: 11 };
  var zt = Math.abs;
  function Nt(e) {
    return (0 < e) - (e < 0) || +e;
  }
  function Jt() {
    ...
    return m
      ? ((e = U(i / 60)),
        ...
        (n = m < 0 ? "-" : ""),
        (d = Nt(this._months) !== Nt(m) ? "-" : ""),
        (r = Nt(this._days) !== Nt(m) ? "-" : ""),
        (_ = Nt(this._milliseconds) !== Nt(m) ? "-" : ""),
        n +
          "P" +
          (t ? d + t + "Y" : "") +
          (o ? d + o + "M" : "") +
  ...
  (Rt.isValid = function () {
    ...
    (t.updateLocale = function (e, a) {
      ...
      return (
        null != a
          ? ((n = Ke),
            null != qe[e] && null != qe[e].parentLocale
              ? qe[e].set(v(qe[e]._config, a))
              : (null != (s = Qe(e)) && (n = s._config),
                (a = v(n, a)),
                null == s && (a.abbr = e),
                ((t = new H(a)).parentLocale = qe[e]),
                (qe[e] = t)),
            Xe(e))
          : null != qe[e] &&
            (null != qe[e].parentLocale
              ? ((qe[e] = qe[e].parentLocale), e === Xe() && Xe(e))
              : null != qe[e] && delete qe[e]),
        qe[e]
      );
    }),
    (t.locales = function () {
    ...
    (t.weekdaysShort = function (e, a, t) {
      return lt(e, a, t, "weekdaysShort");
    }),
    (t.normalizeUnits = N),
    (t.relativeTimeRounding = function (e) {
      return void 0 === e ? Et : "function" == typeof e && ((Et = e), !0);
    }),
  ...
  t.defineLocale("az", {
    ...
    ordinal: function (e) {
      ...
      var a = e % 10;
      return e + (ds[a] || ds[(e % 100) - a] || ds[100 <= e ? 100 : null]);
    },
    week: { dow: 1, doy: 7 },
  }),
    t.defineLocale("be", {
  ...
  var ls = [
    ...
    hs = [/^Su/i, /^Lu/i, /^Me([^r]|$)/i, /^Mer/i, /^Ya/i, /^Gw/i, /^Sa/i];
  function cs(e, a, t) {
    var s = e + " ";
    switch (t) {
      case "ss":
      ...
      case "mm":
        return (
          s + (1 === e || (2 !== e && 3 !== e && 4 !== e) ? "minuta" : "minute")
        );
      case "h":
      ...
      case "yy":
        return (
          s + (1 === e || (2 !== e && 3 !== e && 4 !== e) ? "godina" : "godine")
        );
    }
  }
  t.defineLocale("br", {
  ...
  var Ls =
    ...
    Ys = "led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro".split("_"),
    ys = [
      /^led/i,
      /^\xfano/i,
      /^b\u0159e/i,
  ...
  function ks(e, a, t, s) {
    ...
    switch (t) {
      ...
      case "ss":
        return a || s ? n + (ps(e) ? "sekundy" : "sekund") : n + "sekundami";
      case "m":
        return a ? "minuta" : s ? "minutu" : "minutou";
      case "mm":
        return a || s ? n + (ps(e) ? "minuty" : "minut") : n + "minutami";
      case "h":
        return a ? "hodina" : s ? "hodinu" : "hodinou";
      case "hh":
        return a || s ? n + (ps(e) ? "hodiny" : "hodin") : n + "hodinami";
      case "d":
        return a || s ? "den" : "dnem";
      case "dd":
        return a || s ? n + (ps(e) ? "dny" : "dní") : n + "dny";
      case "M":
        return a || s ? "měsíc" : "měsícem";
      case "MM":
        return a || s ? n + (ps(e) ? "měsíce" : "měsíců") : n + "měsíci";
      case "y":
        return a || s ? "rok" : "rokem";
      case "yy":
        return a || s ? n + (ps(e) ? "roky" : "let") : n + "lety";
    }
  }
  function Ds(e, a, t, s) {
    var n = {
  ...
  t.defineLocale("es-us", {
    ...
    monthsShort: function (e, a) {
      return e ? (/-MMM-/.test(a) ? Os[e.month()] : xs[e.month()]) : xs;
    },
    monthsRegex: Ws,
    monthsShortRegex: Ws,
    monthsStrictRegex:
  ...
  t.defineLocale("es", {
    ...
    monthsShort: function (e, a) {
      return e ? (/-MMM-/.test(a) ? Es[e.month()] : As[e.month()]) : As;
    },
    monthsRegex: zs,
    monthsShortRegex: zs,
    monthsStrictRegex:
  ...
  var Bs = "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split(
      "_"
    ),
    Ks = "jan_feb_mrt_apr_mai_jun_jul_aug_sep_okt_nov_des".split("_");
  function qs(e, a, t, s) {
    var n = {
  ...
  function Tn(e, a, t, s) {
    ...
    return 1 === e
      ? n + pn(0, a, t[0], s)
      : a
      ? n + (kn(e) ? Dn(t)[1] : Dn(t)[0])
      : s
      ? n + Dn(t)[1]
      : n + (kn(e) ? Dn(t)[1] : Dn(t)[2]);
  }
  t.defineLocale("lt", {
    months: {
      format:
  ...
  var Rn = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split(
      "_"
    ),
    ...
    translate: function (e, a, t) {
      ...
      return 1 === t.length
        ? a
          ? s[0]
          : s[1]
        : e + " " + _d.correctGrammaticalCase(e, s);
    },
  };
    ...
    translate: function (e, a, t) {
      ...
      return 1 === t.length
        ? a
          ? s[0]
          : s[1]
        : e + " " + id.correctGrammaticalCase(e, s);
    },
  };
  t.defineLocale("sr", {
    months:
  ...
  t.defineLocale("tg", {
    ...
    ordinal: function (e) {
      return e + (md[e] || md[e % 10] || md[100 <= e ? 100 : null]);
    },
    week: { dow: 1, doy: 7 },
  }),
    t.defineLocale("th", {
    ...
    ordinal: function (e, a) {
      switch (a) {
        ...
        default:
          ...
          var t = e % 10;
          return e + (ld[t] || ld[(e % 100) - t] || ld[100 <= e ? 100 : null]);
      }
    },
    week: { dow: 1, doy: 7 },
  }),
  ...
  var Md = "pagh_wa’_cha’_wej_loS_vagh_jav_Soch_chorgh_Hut".split("_");
  function hd(e, a, t, s) {
    var n = (function (e) {
    ...
    ordinal: function (e, a) {
      switch (a) {
        ...
        default:
          if (0 === e) return e + "'ıncı";
          var t = e % 10;
          return e + (cd[t] || cd[(e % 100) - t] || cd[100 <= e ? 100 : null]);
      }
    },
    week: { dow: 1, doy: 7 },
  }),
  ...
  var fd = [
    ...
    pd = ["اتوار", "پیر", "منگل", "بدھ", "جمعرات", "جمعہ", "ہفتہ"];
  return (
    t.defineLocale("ur", {
      months: fd,
      monthsShort: fd,
