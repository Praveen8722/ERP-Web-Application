  ...
  e.on("change", function () {
    ...
    $(document).ready(function () {
      $("#departments-table").DataTable({
        ...
        serverSide: !0,
        order: [[0, "asc"]],
        ajax: { url: route("departments.index") },
        columnDefs: [
          {
            targets: [1],
            orderable: !1,
        ...
        $(document).on("submit", "#addNewForm", function (e) {
          ...
          var t =
              ...
              $("<div />")
                ...
                .trim()
                .replace(/ \r\n\t/g, ""),
            r = jQuery(this).find("#btnSave");
          if ((r.button("loading"), "" == $("#color").val()))
            return (
          ...
          $.ajax({
            ...
            success: function (e) {
              e.success &&
                ...
                $("#AddModal").modal("hide"),
                $("#departments-table").DataTable().ajax.reload(null, !1),
        ...
        $(document).on("submit", "#editForm", function (e) {
          ...
          var t =
              ...
              $("<div />")
                ...
                .trim()
                .replace(/ \r\n\t/g, ""),
            r = ($(this), jQuery(this).find("#btnEditSave"));
          if (
            (r.button("loading"), $("#editDescription").summernote("isEmpty"))
          )
            $("#editDescription").val("");
          else if (t)
            return (
          ...
          var a = $(this).serializeArray(),
            o = $("#departmentId").val();
          $.ajax({
            url: route("departments-update", o),
            type: "post",
            data: a,
            success: function (e) {
              e.success &&
