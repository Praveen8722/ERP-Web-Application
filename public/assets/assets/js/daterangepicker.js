  ...
  var a = function (a, i, s) {
    if (
      ...
      "object" === _typeof(i.locale) &&
        ...
        "object" === _typeof(i.locale.daysOfWeek) &&
          (this.locale.daysOfWeek = i.locale.daysOfWeek.slice()),
        "object" === _typeof(i.locale.monthNames) &&
    ...
    if (
      ...
      "object" === _typeof(i.startDate) && (this.startDate = t(i.startDate)),
      "object" === _typeof(i.endDate) && (this.endDate = t(i.endDate)),
      "object" === _typeof(i.minDate) && (this.minDate = t(i.minDate)),
      "object" === _typeof(i.maxDate) && (this.maxDate = t(i.maxDate)),
      this.minDate &&
      ...
      "object" === _typeof(i.maxSpan) && (this.maxSpan = i.maxSpan),
      "object" === _typeof(i.dateLimit) && (this.maxSpan = i.dateLimit),
      ...
      "object" === _typeof(i.buttonClasses) &&
    ...
    "function" == typeof s && (this.callback = s),
      ...
      "object" === _typeof(i.ranges) && this.container.addClass("show-ranges"),
      this.singleDatePicker &&
          ...
          for (
            ...
            (!I || (v && L >= v.month())) && (!B || (C && L <= C.month()))
              ...
              : (A +=
                  ...
                  "</option>");
          A += "</select>";
          for (var N = '<select class="yearselect">', E = S; E <= M; E++)
            N +=
              '<option value="' +
              E +
              '"' +
