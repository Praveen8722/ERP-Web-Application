...
(function () {
    ...
    resource: {
      ...
      tags: [
        ...
        },
        {
          ...
          vtp_instanceDestinationId: "G-1CNR3975H1",
          tag_id: 3,
        },
        {
  ...
  hi.Ya = "dataLayer";
  hi.Zm =
    "ChAI8ISEtAYQg5j9oN7L8OIuEiUAp6OfQd2q+46BbDazIhtJ9ql8upF0QpZ7SghL60dKpvxCG5hVGgIi0w\x3d\x3d";
  var ji = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var hs = function (a) {
      if (fs) {
        if (a >= 0 && a < gs.length && gs[a]) {
          var b;
          (b = gs[a]) == null || b.disconnect();
          gs[a] = void 0;
        }
    ...
    ks = function (a, b, c) {
      ...
      return G.setInterval(is(a, b, c), 1e3);
    },
    is = function (a, b, c) {
      function d(k, m) {
    ...
    js = function (a, b, c) {
      for (
        ...
        d.observe(b[e]);
      for (var f = 0; f < gs.length; f++) if (!gs[f]) return (gs[f] = d), f;
      return gs.push(d) - 1;
    },
    gs = [],
    fs = !(!G.IntersectionObserver || !G.IntersectionObserverEntry);
      ...
      if (qb(d))
        try {
          c[a] = function (e, f, g) {
            ...
            var k = G.location.href;
            b({ source: a, state: e, url: ej(U(k)), Ga: bj(U(k), "fragment") });
          };
        } catch (e) {}
    },
    eC = function (a) {
        ...
        var n = a(),
          ...
          r =
            k !== void 0
              ...
              ? 0
              : Math.round((q / p) * 100),
          t = H.hidden ? !1 : es(c) >= 0.5;
        d();
        var u = void 0;
        b !== void 0 && (u = [b]);
        var v = Pz(c, "gtm.video", u);
  ...
  var FC = function (a, b, c) {
      var d = a.map(function (g) {
        return { Fa: g, Ne: g, Le: void 0 };
      });
      if (!b.length) return d;
      var e = b.map(function (g) {
        return { Fa: g * c, Ne: void 0, Le: g };
      });
    ...
    IC = function (a, b) {
      ...
      function f(E) {
        switch (E) {
          case 1:
            ...
            y = a.getPlaybackRate();
            b.Rg ? ny(t.createEvent("start")) : t.pd();
            u = FC(b.Gh, b.Fh, a.getDuration());
            return g(E);
          default:
            return f;
        }
      ...
      function k(E) {
        ...
        switch (E) {
          ...
          case 3:
            ...
            C =
              Math.abs(((Cb().getTime() - A) / 1e3) * y - F) > 1
                ? "seek"
                : C || "buffering";
            a.getCurrentTime() && (b.Qg ? ny(t.createEvent(C)) : t.pd());
            q();
            return m;
          case -1:
            return e(E);
      ...
      function n() {
        ...
        b.Pg && ny(t.createEvent("complete", 1));
        return e(-1);
      }
      function p() {}
      function q() {
      ...
      function r() {
        if (u.length && y !== 0) {
          ...
          c = function () {
            ...
            u.length > 0 &&
              u[0].Fa === C.Fa &&
              (u.shift(), ny(t.createEvent("progress", C.Le, C.Ne)));
            r();
          };
    ...
    JC = function (a, b) {
      if (
        !a.getAttribute("data-gtm-yt-inspected-" + b.Bb) &&
        (oc(a, "data-gtm-yt-inspected-" + b.Bb), LC(a, b.xe))
      ) {
        a.id || (a.id = MC());
        var c = G.YT,
          d = c.get(a.id);
      ...
      if (NC(c, "embed/")) {
        ...
        if (b) {
          ...
          c.indexOf("origin=") > -1
            ? (d = c + e + "enablejsapi=1")
            : (DC ||
                ((DC = H.location.protocol + "//" + H.location.hostname),
                H.location.port && (DC += ":" + H.location.port)),
              (d = c + e + "enablejsapi=1&origin=" + encodeURIComponent(DC)));
          var f;
          f = Vb(d);
          a.src = Tb(f).toString();
          return !0;
    ...
    NC = function (a, b) {
      ...
      for (var c = 0; c < CC.length; c++)
        if (a.indexOf("//" + CC[c] + "/" + b) >= 0) return !0;
      return !1;
    },
    MC = function () {
      var a = Math.round(Math.random() * 1e9) + "";
      return H.getElementById(a) ? MC() : a;
    };
  function OC(a, b) {
    var c = this;
    K(this.getName(), ["dustOptions:!PixieMap", "triggerId:?*"], arguments);
    ...
    var d = !!a.get("captureStart"),
      ...
      g = HC(J(a.get("progressThresholdsPercent"))),
      k = GC(J(a.get("progressThresholdsTimeInSeconds"))),
      m = !!a.get("fixMissingApi");
    if (!(d || e || f || g.length || k.length)) return;
    var n = { Rg: d, Pg: e, Qg: f, Fh: g, Gh: k, xe: m, Bb: b },
      p = G.YT,
      q = function () {
        KC(n);
      };
    ...
    I(function () {
      for (
        ...
        if (NC(w, "iframe_api") || NC(w, "player_api")) return b;
      }
      for (
        ...
        if (!EC && LC(x[B], n.xe))
          return Bc("https://www.youtube.com/iframe_api"), (EC = !0), b;
    });
    return b;
  }
  ...
  function yE() {
    ...
    N(this, "read_container_data"),
      T(37) && xE
        ? (a = xE)
        : (a.set("containerId", "G-1CNR3975H1"),
          a.set("version", "1"),
  ...
  function OE(a, b) {
    ...
    var d = bj(U(G.location.href), "query"),
      e = aj(d, a, b);
    c = fd(e, this.F);
    return c;
  }
