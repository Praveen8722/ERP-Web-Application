                ...
                switch (_typeof(r)) {
                  ...
                  case "object":
                    ...
                    (a.confirmButtonText = a.showCancelButton
                      ...
                      (a.confirmButtonText = o("confirmButtonText")),
            ...
            handleButton: function (t, n, o) {
              ...
              switch (
                (m &&
                  ...
                  (c = r.colorLuminance(u, -0.04)),
                  (d = r.colorLuminance(u, -0.14))),
                f.type)
              ) {
                case "mouseover":
                  i(c);
          ...
          (r.sweetAlertInitialize = c),
            ...
            (r.openModal = function (n) {
              ...
              l.fadeIn(p(), 10),
                ...
                o.querySelector("button.confirm").focus(),
                setTimeout(function () {
      ...
      8: [
        function (e, t, o) {
          ...
          (o.default = function (e) {
            ...
            if (
              (s.hide(t.querySelectorAll(".sa-icon")), e.type && !r.isIE8())
            ) {
              var f = (function () {
                ...
                -1 !==
                  ...
                  ((i = t.querySelector(".sa-icon.sa-" + e.type)), s.show(i));
                var u = a.getInput();
                switch (e.type) {
                  case "success":
                    s.addClass(i, "animate"),
                      s.addClass(
                    ...
                    break;
                  case "error":
                    s.addClass(i, "animateErrorIcon"),
                      s.addClass(i.querySelector(".sa-x-mark"), "animateXMark");
                    break;
                  case "warning":
                    s.addClass(i, "pulseWarning"),
                      s.addClass(
                        i.querySelector(".sa-body"),
                        "pulseWarningIns"
                      ),
                      s.addClass(i.querySelector(".sa-dot"), "pulseWarningIns");
                    break;
                  case "input":
                  case "prompt":
            ...
            t.setAttribute("data-has-cancel-button", e.showCancelButton),
              ...
              e.confirmButtonColor &&
                ...
                a.setFocusStyle(c, e.confirmButtonColor)),
