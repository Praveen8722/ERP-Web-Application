...
!(function (e, t) {
  ...
  function m(e) {
    ...
    if (c || m) {
      var g = t(e);
      (c -= u(g, "x")), (m -= u(g, "y")), (f.width -= c), (f.height -= m);
    }
    return h(f);
  }
  function g(e, n) {
    var r = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
      ...
      g = parseFloat(c.borderLeftWidth);
    ...
    if (((v.marginTop = 0), (v.marginLeft = 0), !f && s)) {
      var b = parseFloat(c.marginTop),
        w = parseFloat(c.marginLeft);
      (v.top -= d - b),
        (v.bottom -= d - b),
        (v.left -= g - w),
        (v.right -= g - w),
  ...
  function y(e, t, i, f) {
    ...
    if ("viewport" === f) p = v(l, s);
      ...
      var c = g(u, l, s);
      if ("HTML" !== u.nodeName || b(l)) p = c;
      else {
        var h = d(e.ownerDocument),
          m = h.height,
          y = h.width;
        (p.top += c.top - c.marginTop),
          (p.bottom = m + c.top),
          (p.left += c.left - c.marginLeft),
          (p.right = y + c.left);
      }
    }
  ...
  function x(e, t, n, o, r) {
    ...
    var f = y(n, o, i, r),
      ...
      a = Object.keys(s)
        .map(function (e) {
          return te({ key: e }, s[e], { area: E(s[e]) });
        })
        .sort(function (e, t) {
  ...
  function M(e, t, n, r) {
    ...
    var i = o(e);
    return (
      A(i, "scroll", n.updateBound, n.scrollParents),
      (n.scrollElement = i),
      (n.eventsEnabled = !0),
      n
    );
  ...
  return (
    (ae.Utils = ("undefined" == typeof window ? global : window).PopperUtils),
    (ae.placements = oe),
    (ae.Defaults = {
      placement: "bottom",
      positionFixed: !1,
        ...
        arrow: {
          ...
          fn: function (e, n) {
            ...
            return (
              (E = z(V(s[l] - g, E), 0)),
              (e.arrowElement = r),
              (e.offsets.arrow = (ee((o = {}), c, _(E)), ee(o, d, ""), o)),
              e
            );
          },
          element: "[x-arrow]",
        ...
        computeStyle: {
          ...
          fn: function (e, t) {
            ...
            if (
              ...
              var b = "bottom" == h ? -1 : 1,
                w = "right" == g ? -1 : 1;
              (c[h] = a * b), (c[g] = s * w), (c.willChange = h + ", " + g);
            }
