...
const columns = [
    {
        accessorKey: "headOfOrganisation",
        header: "Head of Organisation",
        size: 40,
    ...
    },
    {
        ...
        header: "Services",
        size: 40,
        Cell: ({ cell }) => cell.getValue() ? cell.getValue().map(service => service.servicesType).join(", ") : "" // Check if cell.getValue() is defined before mapping
    },
    {
        accessorKey: "phone",
        header: "Phone",
